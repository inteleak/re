...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Otomotiv Asistanına hoş geldiniz. 🚗 Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: 'Merhabalar, Audi A3 Sedan S-Line 2024 modeliniz için test sürüşü yapabilir miyim?', time: '14:30' },
  { sender: 'bot', text: 'Hemen kontrol ediyorum... 🔍 Evet, test aracımız mevcut! Cuma günü saat 14:00 için test sürüşü randevunuzu oluşturmamı ister misiniz?', time: '14:31' },
  { sender: 'user', text: "Aracın kredi seçenekleri neler? Takas desteği mevcut mu?", time: '14:31' },
  { sender: 'bot', text: "Otomobiliniz için 36 aya varan vade seçeneklerimiz bulunuyor. 💰 Ayrıca mevcut aracınız için takas değerlendirmesi yapabiliriz.", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman randevumu tamamlayalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Talebiniz alındı! 🎉 Adınıza randevunuz oluşturuldu ve onay detayı WhatsApp ile iletildi. İyi sürüşler! 🔑', time: '14:33' }
];

const AutomotivePhoneDialogueSection: React.FC = () => {
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Müşterinin tahlil sonuçlarından randevu saatlerine, işlem detaylarından iade randevularına kadar tüm karmaşık sorularını otomotiv politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default AutomotivePhoneDialogueSection;
