...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Güzellik Merkezi Asistanına hoş geldiniz. 💅 Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: "Merhabalar, lazer epilasyon ve cilt bakımı kampanyalarınız hakkında bilgi almak istiyorum.", time: '14:30' },
  { sender: 'bot', text: 'Tabii ki yardımcı olayım... 🔍 Şu an tüm vücut lazer epilasyon + medikal cilt bakımında yaza özel %30 indirimimiz var. Fiyatlarını ve detaylarını iletmemi ister misiniz?', time: '14:31' },
  { sender: 'user', text: "Harika olur! Peki hafta sonu Cumartesi günü öğleden sonra için randevu oluşturabiliyor muyuz?", time: '14:31' },
  { sender: 'bot', text: "Evet, Cumartesi günü 14:00 ve 16:30 seanslarımız müsait. 🌸 Ön görüşme ve ilk seans randevunuzu 14:00'e oluşturmamı ister misiniz?", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman randevumu Cumartesi 14:00 için oluşturalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Randevunuz oluşturuldu! 🎉 Onay mesajınız ve konum bilgisi WhatsApp üzerinden iletildi. Kendinize iyi bakın, görüşmek üzere! ✨', time: '14:33' }
];

const BeautyPhoneDialogueSection: React.FC = () => {
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Müşterinin fiyat listelerinden rezervasyon saatlerine, işlem detaylarından iptal/iade süreçlerine kadar tüm karmaşık sorularını işletme politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran müşterilere anında en cazip alternatifleri (özel indirimler, bakım paketleri) listeler, ikna eder ve WhatsApp üzerinden güvenli rezervasyon onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default BeautyPhoneDialogueSection;
