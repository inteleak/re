...
const cards = [
    {
        ...
        description: "Tek bir komutla, blog yazılarından pazarlama metinlerine kadar SEO dostu ve benzersiz içerikler oluşturun.",
        theme: {
    ...
    },
    {
        ...
        description: "Hayal ettiğiniz görselleri saniyeler içinde metin komutlarıyla gerçeğe dönüştürün.",
        theme: {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="11" r="3"/><path d="M15 15l-3 7-3-7"/>
            </svg>
        )
    },
    {
        title: "Yazılım Asistanı",
        description: "Hata ayıklamadan yeni kod blokları oluşturmaya kadar yazılım geliştirme sürecinizi hızlandırın.",
        theme: {
    ...
    },
    {
        ...
        description: "Karmaşık sorulara anında yanıtlar alın, projeler planlayın ve iş akışlarınızı optimize edin.",
        theme: {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="7" width="20" height="15" rx="2" ry="2"/><path d="M16 2a4 4 0 0 1 4 4v1H4V6a4 4 0 0 1 4-4h8z"/><line x1="12" y1="12" x2="12" y2="16"/>
            </svg>
        )
    },
    {
        title: "Video ve Ses Üretimi",
        description: "Metinleri konuşmaya, sesleri müziğe dönüştürerek projelerinize profesyonel bir dokunuş katın.",
        theme: {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M15.5 14.5L22 22"/><path d="M13 13L16 16"/><path d="M12 21.5V12a4 4 0 0 0-4-4H3.5"/><path d="M5.5 2C8 2 10.5 3.5 10.5 6"/><path d="M12 21.5V12a4 4 0 0 0-4-4H3.5"/><path d="M18.5 2C21 2 23.5 3.5 23.5 6"/>
            </svg>
        )
    },
    {
        title: "Gerçek Zamanlı Sohbet",
        description: "Fikirlerinizi anında test edin ve bir yapay zeka ile dinamik olarak beyin fırtınası yapın.",
        theme: {
    ...
    return (
        <section className="w-full relative z-20 mt-16 pb-8">
            ...
            <div className="container mx-auto px-4 lg:px-8 pt-4 antialiased">
                ...
                >
                    Yaratıcılığınızı serbest bırakın ve fikirlerinizi hayata geçirin. Platformumuzun sunduğu avantajlardan bazıları:
                </motion.p>
                        ...
                        {cards.map((card, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`absolute -top-12 -right-12 w-24 h-24 rounded-full blur-[20px] transition-all duration-700 pointer-events-none ${t.circle}`}></div>
                                    ...
                                    <div className="flex-grow min-w-0 relative z-10">
                                        <h3 className={`text-sm font-bold text-white ${t.text} transition-colors duration-300 mb-1 truncate`}>
                                            {card.title}
                                        </h3>
