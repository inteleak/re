...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Diyetisyen Asistanına hoş geldiniz. 🛍️ Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: 'Merhabalar, kilo vermek istiyorum. Size gelmeden önce online bir görüşme veya analiz yapabiliyor muyuz?', time: '14:30' },
  { sender: 'bot', text: 'Sizi tebrik ederim öncelikle! 🔍 Evet, diyetisyenimizle ücretsiz bir ön değerlendirme ve vucüt analizi randevusu ayarlayabiliriz. İster misiniz?', time: '14:31' },
  { sender: 'user', text: "Çok sevinirim. Peki kişiye özel online diyet yazıyor musunuz? Tahlil falan istiyor musunuz?", time: '14:31' },
  { sender: 'bot', text: "Elbette, tamamen size özel (hastalık, yaş, hedef) listeler yazıyoruz. 📋 Ön görüşmeden sonra sizden bazı kan tahlilleri isteyebiliriz.", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman ön görüşme randevumu oluşturalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Talebiniz alındı! 🎉 Adınıza randevunuz oluşturuldu ve onay bağlantısı WhatsApp üzerinden iletildi. Sağlıklı günler! 🍏', time: '14:33' }
];

const DietitianPhoneDialogueSection: React.FC = () => {
            ...
            <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/20 via-slate-900/95 to-slate-950 text-white rounded-3xl p-4 md:p-5 lg:p-6 border border-slate-705/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden w-full">
                ...
                <div className="text-center mb-4 md:mb-5">
                    ...
                    <p className="text-[11px] md:text-xs text-slate-300 max-w-xl mx-auto leading-relaxed">
                        Yapay zeka asistanımızın danışan sorularını nasıl yanıtladığını ve randevu süreçlerini nasıl kolaylaştırdığını canlı olarak görün.
                    </p>
                </div>
                            ...
                            <div className="relative rounded-[2.5rem] border-[5px] border-slate-800 bg-slate-950 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col h-[400px] md:h-[430px] transition-all duration-300 hover:border-slate-700">
                                ...
                                <div className="bg-slate-900/95 border-b border-slate-800/80 px-3 py-2 flex items-center justify-between z-10">
                                    <div className="flex items-center space-x-1.5">
                                        ...
                                        <span className="font-bold text-slate-100 text-[10px] tracking-wide">Danışan Havuzu</span>
                                    </div>
                                        ...
                                        <div className={`flex items-start ${typingSender === 'user' ? 'ml-auto' : ''}`}>
                                            <div className={`px-2.5 py-1.5 rounded-xl text-slate-400 flex items-center space-x-1 border shadow-xs ${
                                                ...
                                                <span className="text-[8px] font-bold uppercase tracking-wider text-slate-400 mr-1">
                                                    {typingSender === 'user' ? 'Danışan' : 'Yapay Zeka'}
                                                </span>
                                                <span className="flex space-x-0.5">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Danışannin tahlil sonuçlarından randevu saatlerine, işlem detaylarından iade randevularına kadar tüm karmaşık sorularını diyetisyen politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran danışanlere anında en cazip alternatifleri (ücretsiz vücut analizi, sağlıklı tarifler) listeler, ikna eder ve WhatsApp üzerinden güvenli randevu onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        WhatsApp, Instagram DM, web sitesi canlı yardım ve Telegram gibi farklı kanallardan akan tüm danışan hacmini tek bir akıllı algoritma ile koordine eder. Randevu ve danışan bilgilerini pürüzsüz eşzamanlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default DietitianPhoneDialogueSection;
