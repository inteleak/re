...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Otel Asistanına hoş geldiniz. 🏨 Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: 'Hafta sonu için 2 kişilik deniz manzaralı oda fiyatı alabilir miyim?', time: '14:30' },
  { sender: 'bot', text: 'Hemen kontrol ediyorum... 🔍 Cumartesi girişli deniz manzaralı Delüks Odamız müsait! Gecelik 2.500 TL (Kahvaltı ve Spa dahil). Rezervasyonunuzu başlatmamı ister misiniz?', time: '14:31' },
  { sender: 'user', text: 'Odalarda kahve makinesi var mı? Bir de geç giriş yapacağız.', time: '14:31' },
  { sender: 'bot', text: 'Evet! Tüm odalarımızda Nespresso makinesi ücretsizdir. ☕ Ayrıca mobil check-in yaparak resepsiyondaki sırayı tamamen atlayabilirsiniz.', time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman rezervasyonumu tamamlayalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Talebiniz alındı! 🎉 Adınıza ön rezervasyon yapıldı ve onay bağlantısı WhatsApp telefonunuza iletildi. İyi tatiller dileriz! 🌴', time: '14:33' }
];

const DualPhoneDialogueSection: React.FC = () => {
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Misafirin kahve makinesinden geç giriş detaylarına, evcil hayvan kurallarından spa rezervasyonlarına kadar tüm karmaşık sorularını tesis politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran misafirlere anında en cazip alternatifleri (oda manzarası, kahvaltı, spa teklifi) listeler, ikna eder ve WhatsApp üzerinden güvenli rezervasyon onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        WhatsApp, Instagram DM, web sitesi canlı yardım ve Telegram gibi farklı kanallardan akan tüm misafir hacmini tek bir akıllı algoritma ile koordine eder. Rezervasyon ve müşteri bilgilerini pürüzsüz eşzamanlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default DualPhoneDialogueSection;
