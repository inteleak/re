...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Eğitim Asistanına hoş geldiniz. 🎓 Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: 'Merhabalar, hafta sonu İngilizce A2 seviyesi için boş kontenjanınız var mı?', time: '14:30' },
  { sender: 'bot', text: 'Hemen kontrol ediyorum... 🔍 Cumartesi sabah 10:00 ve Pazar 14:00 sınıflarımızda boş yerimiz mevcut! Aylık kayıt ücreti 2.500 TL. Ön kaydınızı oluşturmamı ister misiniz?', time: '14:31' },
  { sender: 'user', text: "Ders materyallerini sisteme ne zaman yüklüyorsunuz? Derse devam zorunluluğu var mı?", time: '14:31' },
  { sender: 'bot', text: "Ders materyalleriniz kayıt onayından hemen sonra Öğrenci Portalı üzerinden erişiminize açılmaktadır. 📚 MEB kuralları gereği %80 devam zorunluluğumuz bulunmaktadır.", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman kaydımı tamamlayalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Talebiniz alındı! 🎉 Adınıza ön kaydınız oluşturuldu ve onay bağlantısı WhatsApp üzerinden iletildi. Eğitim hayatınızda başarılar dileriz! 🎓', time: '14:33' }
];

const EducationalPhoneDialogueSection: React.FC = () => {
            ...
            <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/20 via-slate-900/95 to-slate-950 text-white rounded-3xl p-4 md:p-5 lg:p-6 border border-slate-705/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden w-full">
                ...
                <div className="text-center mb-4 md:mb-5">
                    ...
                    <p className="text-[11px] md:text-xs text-slate-300 max-w-xl mx-auto leading-relaxed">
                        Yapay zeka asistanımızın öğrenci sorularını nasıl yanıtladığını ve kayıt süreçlerini nasıl kolaylaştırdığını canlı olarak görün.
                    </p>
                </div>
                                        ...
                                        <div className={`flex items-start ${typingSender === 'user' ? 'ml-auto' : ''}`}>
                                            <div className={`px-2.5 py-1.5 rounded-xl text-slate-400 flex items-center space-x-1 border shadow-xs ${
                                                ...
                                                <span className="text-[8px] font-bold uppercase tracking-wider text-slate-400 mr-1">
                                                    {typingSender === 'user' ? 'Öğrenci' : 'Yapay Zeka'}
                                                </span>
                                                <span className="flex space-x-0.5">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Öğrencinin tahlil sonuçlarından kayıt saatlerine, işlem detaylarından kurs kayıtlarına kadar tüm karmaşık sorularını eğitim politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran öğrencilere anında en cazip alternatifleri (erken kayıt avantajları, ek etüt paketleri) listeler, ikna eder ve WhatsApp üzerinden güvenli kayıt onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        WhatsApp, Instagram DM, web sitesi canlı yardım ve Telegram gibi farklı kanallardan akan tüm öğrenci hacmini tek bir akıllı algoritma ile koordine eder. Kayıt ve müşteri bilgilerini pürüzsüz eşzamanlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default EducationalPhoneDialogueSection;
