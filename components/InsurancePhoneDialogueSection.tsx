...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Sigorta Asistanına hoş geldiniz. 🛡️ Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: "Merhabalar, aracım için kasko teklifi almak istiyorum. Hangi bilgileri paylaşmalıyım?", time: '14:30' },
  { sender: 'bot', text: 'Size memnuniyetle yardımcı olacağım... 🔍 Ruhsat bilgilerinizi veya T.C. Kimlik ve Plaka numaranızı paylaşırsanız hemen en uygun teklifleri oluşturabilirim.', time: '14:31' },
  { sender: 'user', text: "Tamamdır, paylaşıyorum. Peki, tamamlayıcı sağlık sigortası (TSS) yapıyor musunuz? Fiyatları ortalama nedir?", time: '14:31' },
  { sender: 'bot', text: "Evet, 15+ anlaşmalı kurumla en kapsamlı Tamamlayıcı Sağlık Sigortası poliçelerini sunuyoruz. ⚕️ Aylık 900 TL'den başlayan taksit imkanlarımız mevcut.", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman kasko ve TSS için poliçemi oluşturalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'İşleminiz başlatıldı! 🎉 Özel ödeme linkiniz ve poliçe taslağınız WhatsApp üzerinden iletildi. Güvenli günler dileriz! 🛡️', time: '14:33' }
];

const InsurancePhoneDialogueSection: React.FC = () => {
            ...
            <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/20 via-slate-900/95 to-slate-950 text-white rounded-3xl p-4 md:p-5 lg:p-6 border border-slate-705/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden w-full">
                ...
                <div className="text-center mb-4 md:mb-5">
                    ...
                    <p className="text-[11px] md:text-xs text-slate-300 max-w-xl mx-auto leading-relaxed">
                        Yapay zeka asistanımızın müşteri sorularını nasıl yanıtladığını ve rezervasyon süreçlerini nasıl kolaylaştırdığını canlı olarak görün.
                    </p>
                </div>
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Müşterinin teminat detaylarından rezervasyon saatlerine, işlem detaylarından iptal/iade süreçlerine kadar tüm karmaşık sorularını işletme politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran müşterilere anında en cazip alternatifleri (özel indirimler, kasko kampanyaları) listeler, ikna eder ve WhatsApp üzerinden güvenli rezervasyon onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        WhatsApp, Instagram DM, web sitesi canlı yardım ve Telegram gibi farklı kanallardan akan tüm müşteri hacmini tek bir akıllı algoritma ile koordine eder. Rezervasyon ve müşteri bilgilerini pürüzsüz eşzamanlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default InsurancePhoneDialogueSection;
