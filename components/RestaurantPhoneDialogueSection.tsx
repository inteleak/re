...
const dialogue: ChatMessage[] = [
  { sender: 'bot', text: 'Merhaba! Mortanas AI Restoran Asistanına hoş geldiniz. 🍽️ Size nasıl yardımcı olabilirim?', time: '14:30' },
  { sender: 'user', text: 'Merhabalar, bu akşam saat 20:00 için 4 kişilik rezervasyon yaptırmak istiyorum, yeriniz var mı?', time: '14:30' },
  { sender: 'bot', text: 'Hemen kontrol ediyorum... 🔍 Evet, saat 20:00 için cam kenarı masamız müsait! İsterseniz hemen rezervasyonunuzu onaylayabilirim.', time: '14:31' },
  { sender: 'user', text: "Otoparkınız veya vale hizmetiniz var mı? Menünüzde glutensiz seçenekler bulunuyor mu?", time: '14:31' },
  { sender: 'bot', text: "Evet, restoranımızın önünde valemiz mevcuttur. 🚘 Ayrıca menümüzde glutensiz ve vegan birçok özel seçeneğimiz bulunuyor.", time: '14:32' },
  { sender: 'user', text: 'Harika, o zaman rezervasyonumu tamamlayalım lütfen.', time: '14:32' },
  { sender: 'bot', text: 'Talebiniz alındı! 🎉 Adınıza rezervasyonunuz oluşturuldu ve onay bağlantısı WhatsApp üzerinden iletildi. Şimdiden afiyet olsun! 🍷', time: '14:33' }
];

const RestaurantPhoneDialogueSection: React.FC = () => {
            ...
            <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/20 via-slate-900/95 to-slate-950 text-white rounded-3xl p-4 md:p-5 lg:p-6 border border-slate-705/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden w-full">
                ...
                <div className="text-center mb-4 md:mb-5">
                    ...
                    <p className="text-[11px] md:text-xs text-slate-300 max-w-xl mx-auto leading-relaxed">
                        Yapay zeka asistanımızın misafir sorularını nasıl yanıtladığını ve rezervasyon süreçlerini nasıl kolaylaştırdığını canlı olarak görün.
                    </p>
                </div>
                            ...
                            <div className="relative rounded-[2.5rem] border-[5px] border-slate-800 bg-slate-950 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col h-[400px] md:h-[430px] transition-all duration-300 hover:border-slate-700">
                                ...
                                <div className="bg-slate-900/95 border-b border-slate-800/80 px-3 py-2 flex items-center justify-between z-10">
                                    <div className="flex items-center space-x-1.5">
                                        ...
                                        <span className="font-bold text-slate-100 text-[10px] tracking-wide">Misafir Havuzu</span>
                                    </div>
                                        ...
                                        <div className={`flex items-start ${typingSender === 'user' ? 'ml-auto' : ''}`}>
                                            <div className={`px-2.5 py-1.5 rounded-xl text-slate-400 flex items-center space-x-1 border shadow-xs ${
                                                ...
                                                <span className="text-[8px] font-bold uppercase tracking-wider text-slate-400 mr-1">
                                                    {typingSender === 'user' ? 'Misafir' : 'Yapay Zeka'}
                                                </span>
                                                <span className="flex space-x-0.5">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Misafirnin menü içeriklerinden rezervasyon saatlerine, işlem detaylarından iptal/iade süreçlerine kadar tüm karmaşık sorularını işletme politikanıza %100 sadık kalarak bir insan gibi anlar ve anında yanıtlar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        Sadece bilgi vermez; fiyat teklifi soran misafirlere anında en cazip alternatifleri (şefin özel ikramları, şarap eşleşmeleri) listeler, ikna eder ve WhatsApp üzerinden güvenli rezervasyon onay bağlantısını göndererek satışı kapatır.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-slate-800 bg-slate-900/45 p-4 rounded-2xl relative overflow-hidden group hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] backdrop-blur-md">
                            ...
                            <div className="flex items-start space-x-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-slate-300/90 leading-relaxed mt-1.5 font-sans">
                                        WhatsApp, Instagram DM, web sitesi canlı yardım ve Telegram gibi farklı kanallardan akan tüm misafir hacmini tek bir akıllı algoritma ile koordine eder. Rezervasyon ve misafir bilgilerini pürüzsüz eşzamanlar.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default RestaurantPhoneDialogueSection;
