                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-indigo-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Her 3 misafirden 2'si, kişiselleştirilmiş teklifler sunan sitelerden rezervasyon yapıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-purple-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Akıllı otomasyon kullanan oteller, OTA komisyonlarından kurtularak kârlılığını artırıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-cyan-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">AI konsiyerj ile hiçbir potansiyel misafir rezervasyonunu veya talebi kaçırmayın.</p>
                        </div>
                    </div>
                </div>
            </div>
...
const AiHotelSitePage: React.FC = () => {
    ...
    const faqs: FAQ[] = [
        { 
            ...
            answer: "Geleneksel bir web sitesinin ötesinde, misafirlerinizle 7/24 sohbet eden, doğrudan rezervasyon alarak komisyonlardan kurtaran akıllı bir platformdur."
        },
        { 
        ...
        { 
            ...
            answer: "Kesinlikle. Kurulum aşamasında, renkleri, logoyu ve tasarımı otelinizin kurumsal kimliğine tam uyumlu hale getiriyoruz."
        },
        { 
            question: "Raporlama ve analiz özellikleri nelerdir?",
            answer: "Yönetim panelinden, web trafiği, en çok sorulan sorular ve doğrudan rezervasyon gelirleri gibi kritik veriye ulaşabilirsiniz."
        },
        {
            question: "Doğrudan rezervasyonlar için komisyon ödüyor muyum?",
            answer: "Hayır, sitemiz üzerinden yapılan hiçbir rezervasyondan ekstra komisyon veya işlem ücreti kesilmez. Tüm kâr otelinize kalır."
        },
        {
        ...
        },
        {
            ...
            answer: "Yönetim panelinden kolayca SEO uyumlu blog yazıları oluşturabilir, kampanyalarınızı misafirlerinize sunabilirsiniz."
        }
    ];
    ...
    const aiConciergeFeatures = [
        { icon: <i className="fas fa-bolt"></i>, title: "Anında Rezervasyon", description: "Oda müsaitliği sorar, en iyi fiyatı sunar ve rezervasyonu saniyeler içinde tamamlar." },
        { icon: <i className="fas fa-concierge-bell"></i>, title: "Oda Servisi & Talep Yönetimi", description: "Misafirleriniz web sitenizden ayrılmadan havlu, yastık isteyebilir veya oda servisi siparişi verebilir." },
        ...
        { icon: <i className="fas fa-star-half-alt"></i>, title: "Anlık Geri Bildirim Toplama", description: "Konaklama sonrası misafir memnuniyetini ölçmek için sohbet üzerinden anket yapar ve yorumları analiz eder." },
        { icon: <i className="fas fa-arrow-up-right-dots"></i>, title: "Upsell & Cross-sell", description: "Spa randevusu, restoran rezervasyonu veya tur paketi gibi ek hizmetleri proaktif olarak önererek misafir başına geliri artırır." }
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] text-white tracking-tight">
                                Misafir Deneyimini Zirveye Taşıyan <br /> 
                                <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text">Akıllı Otel Siteniz</span>
                            </h1>
                            <p className="mt-5 text-base md:text-lg text-slate-300 font-medium leading-relaxed max-w-2xl">
                                Sadece rezervasyon alan bir web sitesinden çok daha fazlası. <strong className="text-white font-semibold text-indigo-100">Mortanas Yapay Zeka Web</strong>, her misafirinize kişiselleştirilmiş bir deneyim sunar, doğrudan rezervasyonlarınızı artırır ve 7/24 çalışan akıllı bir konsiyerj gibi hareket eder.
                            </p>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Luxury AI Hotel Website" className="w-full h-full object-cover aspect-[4/3] transform transition-transform duration-700 group-hover:scale-105" />
                                ...
                                <div className="absolute bottom-6 left-6 p-4 bg-slate-900/60 backdrop-blur-md border border-white/10 rounded-xl">
                                     <div className="flex items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p className="text-blue-200 text-xs text-left">7/24 Misafir Hizmeti</p>
                                         </div>
                                     </div>
                                </div>
                            </div>
                        ...
                        <div className="p-6 md:p-8 lg:p-10 text-center lg:text-left z-10">
                            ...
                            <div className="mt-5 space-y-2 text-left max-w-md mx-auto lg:mx-0">
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>%100 Komisyonsuz</strong> Rezervasyonlar</span>
                                </div>
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                ...
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>Kişiselleştirilmiş</strong> Misafir Deneyimi</span>
                                </div>
                            </div>
