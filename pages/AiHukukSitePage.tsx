...
const HUKUK_FEATURES = [
    ...
    },
    {
        ...
        description: "Müvekkilinize en uygun oda ve paketleri önerir, ek hizmetler (spa, tur vb.) için akıllıca çapraz satış yapar ve randevu sürecini kolaylaştırır.",
        icon: <i className="fas fa-calendar-check"></i>
    },
    {
        title: "7/24 Akıllı Konsiyerj",
        description: "Web sitenizdeki sohbet botu, müvekkillerin sorularını anında yanıtlar, randevu yapar ve hatta oda servisi gibi talepleri CRM'inize iletir.",
    ...
    {
        title: "Otomatik Müvekkil İletişimi",
        description: "Randevu sonrası, konaklama öncesi ve sonrası e-postaları kişiselleştirilmiş içeriklerle otomatik olarak göndererek müvekkillerinizle bağ kurar.",
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
            ...
            <div className="text-center lg:text-left">
                ...
                <p className="mt-4 text-sm md:text-base text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                    Hukukcilik sektörü hızla dijitalleşirken, harekete geçmemek pazar payı ve kârlılık kaybetmek anlamına gelir. Yapay zeka entegrasyonunun somut etkilerini hemen görün.
                </p>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-indigo-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Her 3 müvekkilden 2'si, kişiselleştirilmiş teklifler sunan sitelerden randevu yapıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-purple-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Akıllı otomasyon kullanan hukukler, OTA komisyonlarından kurtularak kârlılığını artırıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-cyan-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">AI konsiyerj ile hiçbir potansiyel müvekkil randevuunu veya talebi kaçırmayın.</p>
                        </div>
                    </div>
                </div>
            </div>
...
const AiHukukSitePage: React.FC = () => {
    ...
    const faqs: FAQ[] = [
        { 
            ...
            answer: "Geleneksel bir web sitesinin ötesinde, müvekkillerinizle 7/24 sohbet eden, doğrudan randevu alarak komisyonlardan kurtaran akıllı bir platformdur."
        },
        { 
        ...
        { 
            ...
            answer: "Kesinlikle. Kurulum aşamasında, renkleri, logoyu ve tasarımı hukukinizin kurumsal kimliğine tam uyumlu hale getiriyoruz."
        },
        { 
        ...
        },
        {
            ...
            answer: "Hayır, sitemiz üzerinden yapılan hiçbir randevudan ekstra komisyon veya işlem ücreti kesilmez. Tüm kâr hukukinize kalır."
        },
        {
        ...
        },
        {
            ...
            answer: "Yönetim panelinden kolayca SEO uyumlu blog yazıları oluşturabilir, kampanyalarınızı müvekkillerinize sunabilirsiniz."
        }
    ];

    const whatsappLink = `https://wa.me/905540118888?text=${encodeURIComponent("Merhaba, Yapay Zeka Hukuk Sitesi hakkında bilgi almak istiyorum.")}`;
    const aiConciergeFeatures = [
        ...
        { icon: <i className="fas fa-concierge-bell"></i>, title: "Oda Servisi & Talep Yönetimi", description: "Müvekkilleriniz web sitenizden ayrılmadan havlu, yastık isteyebilir veya oda servisi siparişi verebilir." },
        ...
        { icon: <i className="fas fa-language"></i>, title: "Çok Dilli Destek", description: "Yabancı müvekkillerinizle kendi dillerinde akıcı bir şekilde iletişim kurarak global müşteri kitlenizi genişletir." },
        { icon: <i className="fas fa-star-half-alt"></i>, title: "Anlık Geri Bildirim Toplama", description: "Konaklama sonrası müvekkil memnuniyetini ölçmek için sohbet üzerinden anket yapar ve yorumları analiz eder." },
        { icon: <i className="fas fa-arrow-up-right-dots"></i>, title: "Upsell & Cross-sell", description: "Spa randevusu, restoran randevuu veya tur paketi gibi ek hizmetleri proaktif olarak önererek müvekkil başına geliri artırır." }
    ];
    const howItWorksSteps = [
        {
            icon: 'fa-plug',
            title: '1. Entegrasyon & Kurulum',
            description: 'Mevcut Hukuk Yönetim Sisteminizi (PMS), kanal yöneticinizi ve ödeme altyapınızı platformumuza sorunsuzca bağlıyoruz.'
        },
        {
            icon: 'fa-brain',
            title: '2. AI Eğitimi & Kişiselleştirme',
            description: 'Yapay zekayı, hukukinizin kimliği, oda tipleri, fiyatlandırma stratejisi ve müvekkil profiliyle eğitiyoruz. Web siteniz markanızın dilini konuşmaya başlıyor.'
        },
        {
            icon: 'fa-rocket',
            title: '3. Aktivasyon & Büyüme',
            description: 'Akıllı web siteniz yayına alınır. İlk günden itibaren komisyonsuz randevu almaya, müvekkil verisi toplamaya ve gelirinizi artırmaya başlarsınız.'
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] text-white tracking-tight">
                                Müvekkil Deneyimini Zirveye Taşıyan <br /> 
                                <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text">Akıllı Hukuk Siteniz</span>
                            </h1>
                            <p className="mt-5 text-base md:text-lg text-slate-300 font-medium leading-relaxed max-w-2xl">
                                Sadece randevu alan bir web sitesinden çok daha fazlası. <strong className="text-white font-semibold text-indigo-100">Mortanas Yapay Zeka Web</strong>, her müvekkilinize kişiselleştirilmiş bir deneyim sunar, doğrudan randevularınızı artırır ve 7/24 çalışan akıllı bir konsiyerj gibi hareket eder.
                            </p>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Luxury AI Hhukuk Website" className="w-full h-full object-cover aspect-[4/3] transform transition-transform duration-700 group-hover:scale-105" />
                                ...
                                <div className="absolute bottom-6 left-6 p-4 bg-slate-900/60 backdrop-blur-md border border-white/10 rounded-xl">
                                     <div className="flex items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p className="text-blue-200 text-xs text-left">7/24 Müvekkil Hizmeti</p>
                                         </div>
                                     </div>
                                </div>
                            </div>
            ...
            <div className="container mx-auto px-8 py-12 space-y-16">
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                               OTA komisyonlarını azaltın, müvekkil sadakatini artırın ve operasyonel verimliliği en üst düzeye çıkarın.
                            </p>
                        </div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                            {HUKUK_FEATURES.map((feature, index) => (
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 grid md:grid-cols-1 lg:grid-cols-3 gap-8">
                       <ProblemSolutionCard
                            ...
                            solution="Yapay zeka siteniz, müvekkilleri doğrudan randevua teşvik ederek bu maliyeti ortadan kaldırır."
                       />
                       <ProblemSolutionCard
                            problem="Mesai saatleri dışında veya yoğun anlarda telefonlara cevap veremez, potansiyel müvekkilleri kaçırırsınız."
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Bu sadece bir chatbot değil; hukukinizin tüm dijital operasyonlarını yöneten, gelir getiren akıllı bir asistandır.
                        </p>
                    </div>
                ...
                {/* Pricing Section */}
                <AiWebPricingSection planName="Yapay Zeka Hukuk Sitesi" themeColor="blue" />
                ...
                <section id="faq" className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 w-full">
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                                Yapay Zeka Hukuk Siteniz hakkında aklınıza takılan en yaygın soruları sizin için yanıtladık.
                            </p>
                        </div>
                        ...
                        <div className="p-6 md:p-8 lg:p-10 text-center lg:text-left z-10">
                            ...
                            <div className="mt-5 space-y-2 text-left max-w-md mx-auto lg:mx-0">
                                ...
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>Kişiselleştirilmiş</strong> Müvekkil Deneyimi</span>
                                </div>
                            </div>
...
export default AiHukukSitePage;