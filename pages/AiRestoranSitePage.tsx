...
const RESTORAN_FEATURES = [
    ...
    {
        title: "Akıllı Sipariş Motoru",
        description: "Müşteriinize en uygun oda ve paketleri önerir, ek hizmetler (spa, tur vb.) için akıllıca çapraz satış yapar ve sipariş sürecini kolaylaştırır.",
        icon: <i className="fas fa-calendar-check"></i>
    },
    {
        title: "7/24 Akıllı Konsiyerj",
        description: "Web sitenizdeki sohbet botu, müşterilerin sorularını anında yanıtlar, sipariş yapar ve hatta oda servisi gibi talepleri CRM'inize iletir.",
    ...
    },
    {
        ...
        description: "Sipariş sonrası, konaklama öncesi ve sonrası e-postaları kişiselleştirilmiş içeriklerle otomatik olarak göndererek müşterilerinizle bağ kurar.",
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
            ...
            <div className="text-center lg:text-left">
                ...
                <p className="mt-4 text-sm md:text-base text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                    Restorancilik sektörü hızla dijitalleşirken, harekete geçmemek pazar payı ve kârlılık kaybetmek anlamına gelir. Yapay zeka entegrasyonunun somut etkilerini hemen görün.
                </p>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-indigo-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Her 3 müşteriden 2'si, kişiselleştirilmiş teklifler sunan sitelerden sipariş yapıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-purple-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Akıllı otomasyon kullanan restoranler, OTA komisyonlarından kurtularak kârlılığını artırıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-cyan-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">AI konsiyerj ile hiçbir potansiyel müşteri siparişunu veya talebi kaçırmayın.</p>
                        </div>
                    </div>
                </div>
            </div>
...
const AiRestoranSitePage: React.FC = () => {
    ...
    const faqs: FAQ[] = [
        { 
            ...
            answer: "Geleneksel bir web sitesinin ötesinde, müşterilerinizle 7/24 sohbet eden, doğrudan sipariş alarak komisyonlardan kurtaran akıllı bir platformdur."
        },
        { 
            question: "Mevcut sipariş sistemimle (PMS) entegre olabilir mi?",
        ...
        { 
            ...
            answer: "Kesinlikle. Kurulum aşamasında, renkleri, logoyu ve tasarımı restoraninizin kurumsal kimliğine tam uyumlu hale getiriyoruz."
        },
        { 
            question: "Raporlama ve analiz özellikleri nelerdir?",
            answer: "Yönetim panelinden, web trafiği, en çok sorulan sorular ve doğrudan sipariş gelirleri gibi kritik veriye ulaşabilirsiniz."
        },
        {
            question: "Doğrudan siparişlar için komisyon ödüyor muyum?",
            answer: "Hayır, sitemiz üzerinden yapılan hiçbir siparişdan ekstra komisyon veya işlem ücreti kesilmez. Tüm kâr restoraninize kalır."
        },
        {
    ...
    const whatsappLink = `https://wa.me/905540118888?text=${encodeURIComponent("Merhaba, Yapay Zeka Restoran Sitesi hakkında bilgi almak istiyorum.")}`;
    const aiConciergeFeatures = [
        { icon: <i className="fas fa-bolt"></i>, title: "Anında Sipariş", description: "Oda müsaitliği sorar, en iyi fiyatı sunar ve siparişu saniyeler içinde tamamlar." },
        ...
        { icon: <i className="fas fa-arrow-up-right-dots"></i>, title: "Upsell & Cross-sell", description: "Spa randevusu, restoran siparişu veya tur paketi gibi ek hizmetleri proaktif olarak önererek müşteri başına geliri artırır." }
    ];
    const howItWorksSteps = [
        {
            icon: 'fa-plug',
            title: '1. Entegrasyon & Kurulum',
            description: 'Mevcut Restoran Yönetim Sisteminizi (PMS), kanal yöneticinizi ve ödeme altyapınızı platformumuza sorunsuzca bağlıyoruz.'
        },
        {
            icon: 'fa-brain',
            title: '2. AI Eğitimi & Kişiselleştirme',
            description: 'Yapay zekayı, restoraninizin kimliği, oda tipleri, fiyatlandırma stratejisi ve müşteri profiliyle eğitiyoruz. Web siteniz markanızın dilini konuşmaya başlıyor.'
        },
        {
            icon: 'fa-rocket',
            title: '3. Aktivasyon & Büyüme',
            description: 'Akıllı web siteniz yayına alınır. İlk günden itibaren komisyonsuz sipariş almaya, müşteri verisi toplamaya ve gelirinizi artırmaya başlarsınız.'
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] text-white tracking-tight">
                                ...
                                <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text">Akıllı Restoran Siteniz</span>
                            </h1>
                            <p className="mt-5 text-base md:text-lg text-slate-300 font-medium leading-relaxed max-w-2xl">
                                Sadece sipariş alan bir web sitesinden çok daha fazlası. <strong className="text-white font-semibold text-indigo-100">Mortanas Yapay Zeka Web</strong>, her müşteriinize kişiselleştirilmiş bir deneyim sunar, doğrudan siparişlarınızı artırır ve 7/24 çalışan akıllı bir konsiyerj gibi hareket eder.
                            </p>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Luxury AI Hrestoran Website" className="w-full h-full object-cover aspect-[4/3] transform transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="container mx-auto px-8 py-12 space-y-16">
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl py-10 md:py-12 -mx-8 px-8 border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                            {RESTORAN_FEATURES.map((feature, index) => (
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-16">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Doğrudan siparişları ve kârlılığı engelleyen yaygın sorunları nasıl aştığımızı görün.
                        </p>
                    </div>
                    <div className="relative z-10 grid md:grid-cols-1 lg:grid-cols-3 gap-8">
                       <ProblemSolutionCard
                            ...
                            solution="Yapay zeka siteniz, müşterileri doğrudan siparişa teşvik ederek bu maliyeti ortadan kaldırır."
                       />
                       <ProblemSolutionCard
                            problem="Mesai saatleri dışında veya yoğun anlarda telefonlara cevap veremez, potansiyel müşterileri kaçırırsınız."
                            solution="AI Chatbot, her soruyu 7/24 anında yanıtlar ve hiçbir sipariş fırsatını kaçırmaz."
                       />
                       <ProblemSolutionCard
                            problem="Her ziyaretçiye aynı standart içeriği göstermek, kişiselleştirme eksikliği nedeniyle dönüşümleri düşürür."
                            solution="AI, her ziyaretçiye özel teklifler ve içerikler sunarak etkileşimi ve sipariş oranını artırır."
                       />
                    </div>
                </section>
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Bu sadece bir chatbot değil; restoraninizin tüm dijital operasyonlarını yöneten, gelir getiren akıllı bir asistandır.
                        </p>
                    </div>
                ...
                {/* Pricing Section */}
                <AiWebPricingSection planName="Yapay Zeka Restoran Sitesi" themeColor="blue" />
                ...
                <section id="faq" className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 w-full">
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                                Yapay Zeka Restoran Siteniz hakkında aklınıza takılan en yaygın soruları sizin için yanıtladık.
                            </p>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 items-center relative z-10">
                        <div className="p-6 md:p-8 lg:p-10 text-center lg:text-left z-10">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white leading-tight">
                                <span className="bg-gradient-to-r from-blue-400 to-cyan-300 text-transparent bg-clip-text">Doğrudan Sipariş</span><br /> Devrimine Katılın
                            </h2>
                            ...
                            <div className="mt-5 space-y-2 text-left max-w-md mx-auto lg:mx-0">
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>%100 Komisyonsuz</strong> Siparişlar</span>
                                </div>
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
...
export default AiRestoranSitePage;