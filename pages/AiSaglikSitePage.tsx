...
const SAGLIK_FEATURES = [
    ...
    {
        title: "Akıllı Online Randevu Motoru",
        description: "Hastainize en uygun oda ve paketleri önerir, ek hizmetler (spa, tur vb.) için akıllıca çapraz satış yapar ve online randevu sürecini kolaylaştırır.",
        icon: <i className="fas fa-calendar-check"></i>
    },
    {
        title: "7/24 Akıllı Konsiyerj",
        description: "Web sitenizdeki sohbet botu, hastalerin sorularını anında yanıtlar, online randevu yapar ve hatta oda servisi gibi talepleri CRM'inize iletir.",
    ...
    {
        title: "Otomatik Hasta İletişimi",
        description: "Online Randevu sonrası, konaklama öncesi ve sonrası e-postaları kişiselleştirilmiş içeriklerle otomatik olarak göndererek hastalerinizle bağ kurar.",
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
            ...
            <div className="text-center lg:text-left">
                ...
                <p className="mt-4 text-sm md:text-base text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                    Klinikcilik sektörü hızla dijitalleşirken, harekete geçmemek pazar payı ve kârlılık kaybetmek anlamına gelir. Yapay zeka entegrasyonunun somut etkilerini hemen görün.
                </p>
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            <h3 className="font-bold text-sm md:text-base text-white mb-1.5 flex items-center group-hover:text-blue-300 transition-colors duration-300">
                                ...
                                Daha Fazla Online Randevu
                            </h3>
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Her 3 hastaden 2'si, kişiselleştirilmiş teklifler sunan sitelerden online randevu yapıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-purple-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Akıllı otomasyon kullanan klinikler, OTA komisyonlarından kurtularak kârlılığını artırıyor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-cyan-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">AI konsiyerj ile hiçbir potansiyel hasta online randevuunu veya talebi kaçırmayın.</p>
                        </div>
                    </div>
                </div>
            </div>
...
const AiSaglikSitePage: React.FC = () => {
    ...
    const faqs: FAQ[] = [
        { 
            ...
            answer: "Geleneksel bir web sitesinin ötesinde, hastalerinizle 7/24 sohbet eden, doğrudan online randevu alarak komisyonlardan kurtaran akıllı bir platformdur."
        },
        { 
            question: "Mevcut online randevu sistemimle (PMS) entegre olabilir mi?",
        ...
        { 
            ...
            answer: "Kesinlikle. Kurulum aşamasında, renkleri, logoyu ve tasarımı klinikinizin kurumsal kimliğine tam uyumlu hale getiriyoruz."
        },
        { 
            question: "Raporlama ve analiz özellikleri nelerdir?",
            answer: "Yönetim panelinden, web trafiği, en çok sorulan sorular ve doğrudan online randevu gelirleri gibi kritik veriye ulaşabilirsiniz."
        },
        {
            question: "Doğrudan online randevular için komisyon ödüyor muyum?",
            answer: "Hayır, sitemiz üzerinden yapılan hiçbir online randevudan ekstra komisyon veya işlem ücreti kesilmez. Tüm kâr klinikinize kalır."
        },
        {
        ...
        },
        {
            ...
            answer: "Yönetim panelinden kolayca SEO uyumlu blog yazıları oluşturabilir, kampanyalarınızı hastalerinize sunabilirsiniz."
        }
    ];

    const whatsappLink = `https://wa.me/905540118888?text=${encodeURIComponent("Merhaba, Yapay Zeka Klinik Sitesi hakkında bilgi almak istiyorum.")}`;
    const aiConciergeFeatures = [
        { icon: <i className="fas fa-bolt"></i>, title: "Anında Online Randevu", description: "Oda müsaitliği sorar, en iyi fiyatı sunar ve online randevuu saniyeler içinde tamamlar." },
        { icon: <i className="fas fa-concierge-bell"></i>, title: "Oda Servisi & Talep Yönetimi", description: "Hastaleriniz web sitenizden ayrılmadan havlu, yastık isteyebilir veya oda servisi siparişi verebilir." },
        ...
        { icon: <i className="fas fa-language"></i>, title: "Çok Dilli Destek", description: "Yabancı hastalerinizle kendi dillerinde akıcı bir şekilde iletişim kurarak global müşteri kitlenizi genişletir." },
        { icon: <i className="fas fa-star-half-alt"></i>, title: "Anlık Geri Bildirim Toplama", description: "Konaklama sonrası hasta memnuniyetini ölçmek için sohbet üzerinden anket yapar ve yorumları analiz eder." },
        { icon: <i className="fas fa-arrow-up-right-dots"></i>, title: "Upsell & Cross-sell", description: "Spa randevusu, restoran online randevuu veya tur paketi gibi ek hizmetleri proaktif olarak önererek hasta başına geliri artırır." }
    ];
    const howItWorksSteps = [
        {
            icon: 'fa-plug',
            title: '1. Entegrasyon & Kurulum',
            description: 'Mevcut Klinik Yönetim Sisteminizi (PMS), kanal yöneticinizi ve ödeme altyapınızı platformumuza sorunsuzca bağlıyoruz.'
        },
        {
            icon: 'fa-brain',
            title: '2. AI Eğitimi & Kişiselleştirme',
            description: 'Yapay zekayı, klinikinizin kimliği, oda tipleri, fiyatlandırma stratejisi ve hasta profiliyle eğitiyoruz. Web siteniz markanızın dilini konuşmaya başlıyor.'
        },
        {
            icon: 'fa-rocket',
            title: '3. Aktivasyon & Büyüme',
            description: 'Akıllı web siteniz yayına alınır. İlk günden itibaren komisyonsuz online randevu almaya, hasta verisi toplamaya ve gelirinizi artırmaya başlarsınız.'
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] text-white tracking-tight">
                                Hasta Deneyimini Zirveye Taşıyan <br /> 
                                <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text">Akıllı Klinik Siteniz</span>
                            </h1>
                            <p className="mt-5 text-base md:text-lg text-slate-300 font-medium leading-relaxed max-w-2xl">
                                Sadece online randevu alan bir web sitesinden çok daha fazlası. <strong className="text-white font-semibold text-indigo-100">Mortanas Yapay Zeka Web</strong>, her hastainize kişiselleştirilmiş bir deneyim sunar, doğrudan online randevularınızı artırır ve 7/24 çalışan akıllı bir konsiyerj gibi hareket eder.
                            </p>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Luxury AI Hklinik Website" className="w-full h-full object-cover aspect-[4/3] transform transition-transform duration-700 group-hover:scale-105" />
                                ...
                                <div className="absolute bottom-6 left-6 p-4 bg-slate-900/60 backdrop-blur-md border border-white/10 rounded-xl">
                                     <div className="flex items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p className="text-blue-200 text-xs text-left">7/24 Hasta Hizmeti</p>
                                         </div>
                                     </div>
                                </div>
                            </div>
            ...
            <div className="container mx-auto px-8 py-12 space-y-16">
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                               OTA komisyonlarını azaltın, hasta sadakatini artırın ve operasyonel verimliliği en üst düzeye çıkarın.
                            </p>
                        </div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                            {SAGLIK_FEATURES.map((feature, index) => (
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-16">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Doğrudan online randevuları ve kârlılığı engelleyen yaygın sorunları nasıl aştığımızı görün.
                        </p>
                    </div>
                    <div className="relative z-10 grid md:grid-cols-1 lg:grid-cols-3 gap-8">
                       <ProblemSolutionCard
                            ...
                            solution="Yapay zeka siteniz, hastaleri doğrudan online randevua teşvik ederek bu maliyeti ortadan kaldırır."
                       />
                       <ProblemSolutionCard
                            problem="Mesai saatleri dışında veya yoğun anlarda telefonlara cevap veremez, potansiyel hastaleri kaçırırsınız."
                            solution="AI Chatbot, her soruyu 7/24 anında yanıtlar ve hiçbir online randevu fırsatını kaçırmaz."
                       />
                       <ProblemSolutionCard
                            problem="Her ziyaretçiye aynı standart içeriği göstermek, kişiselleştirme eksikliği nedeniyle dönüşümleri düşürür."
                            solution="AI, her ziyaretçiye özel teklifler ve içerikler sunarak etkileşimi ve online randevu oranını artırır."
                       />
                    </div>
                </section>
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Bu sadece bir chatbot değil; klinikinizin tüm dijital operasyonlarını yöneten, gelir getiren akıllı bir asistandır.
                        </p>
                    </div>
                ...
                {/* Pricing Section */}
                <AiWebPricingSection planName="Yapay Zeka Klinik Sitesi" themeColor="blue" />
                ...
                <section id="faq" className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 w-full">
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                                Yapay Zeka Klinik Siteniz hakkında aklınıza takılan en yaygın soruları sizin için yanıtladık.
                            </p>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 items-center relative z-10">
                        <div className="p-6 md:p-8 lg:p-10 text-center lg:text-left z-10">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white leading-tight">
                                <span className="bg-gradient-to-r from-blue-400 to-cyan-300 text-transparent bg-clip-text">Doğrudan Online Randevu</span><br /> Devrimine Katılın
                            </h2>
                            ...
                            <div className="mt-5 space-y-2 text-left max-w-md mx-auto lg:mx-0">
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>%100 Komisyonsuz</strong> Online Randevular</span>
                                </div>
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                ...
                                <div className="flex items-center text-slate-200 bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 transition-colors hover:bg-white/10 group">
                                    ...
                                    <span className="text-xs md:text-sm"><strong>Kişiselleştirilmiş</strong> Hasta Deneyimi</span>
                                </div>
                            </div>
...
export default AiSaglikSitePage;