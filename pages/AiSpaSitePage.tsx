        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
            ...
            <div className="text-center lg:text-left">
                ...
                <p className="mt-4 text-sm md:text-base text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                    Güzellik Salonucilik sektörü hızla dijitalleşirken, harekete geçmemek pazar payı ve kârlılık kaybetmek anlamına gelir. Yapay zeka entegrasyonunun somut etkilerini hemen görün.
                </p>
                ...
                <div className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl border border-slate-700/50 hover:border-purple-500/50 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] overflow-hidden">
                    ...
                    <div className="flex items-center space-x-4 md:space-x-5 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-400 text-[11px] md:text-xs leading-relaxed font-medium">Akıllı otomasyon kullanan güzellik salonuler, OTA komisyonlarından kurtularak kârlılığını artırıyor.</p>
                        </div>
                    </div>
                </div>
...
const AiSpaSitePage: React.FC = () => {
    ...
    const faqs: FAQ[] = [
        ...
        { 
            ...
            answer: "Kesinlikle. Kurulum aşamasında, renkleri, logoyu ve tasarımı güzellik salonuinizin kurumsal kimliğine tam uyumlu hale getiriyoruz."
        },
        { 
        ...
        },
        {
            ...
            answer: "Hayır, sitemiz üzerinden yapılan hiçbir randevudan ekstra komisyon veya işlem ücreti kesilmez. Tüm kâr güzellik salonuinize kalır."
        },
        {
    ...
    const whatsappLink = `https://wa.me/905540118888?text=${encodeURIComponent("Merhaba, Yapay Zeka Güzellik Salonu Sitesi hakkında bilgi almak istiyorum.")}`;
    ...
    const howItWorksSteps = [
        {
            ...
            description: 'Mevcut Güzellik Salonu Yönetim Sisteminizi (PMS), kanal yöneticinizi ve ödeme altyapınızı platformumuza sorunsuzca bağlıyoruz.'
        },
        {
            icon: 'fa-brain',
            title: '2. AI Eğitimi & Kişiselleştirme',
            description: 'Yapay zekayı, güzellik salonuinizin kimliği, oda tipleri, fiyatlandırma stratejisi ve danışan profiliyle eğitiyoruz. Web siteniz markanızın dilini konuşmaya başlıyor.'
        },
        {
            icon: 'fa-rocket',
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] text-white tracking-tight">
                                ...
                                <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text">Akıllı Güzellik Salonu Siteniz</span>
                            </h1>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Luxury AI Hgüzellik salonu Website" className="w-full h-full object-cover aspect-[4/3] transform transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="container mx-auto px-8 py-12 space-y-16">
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl py-10 md:py-12 -mx-8 px-8 border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                            {SPA_FEATURES.map((feature, index) => (
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                           Bu sadece bir chatbot değil; güzellik salonuinizin tüm dijital operasyonlarını yöneten, gelir getiren akıllı bir asistandır.
                        </p>
                    </div>
                ...
                {/* Pricing Section */}
                <AiWebPricingSection planName="Yapay Zeka Güzellik Salonu Sitesi" themeColor="blue" />
                ...
                <section id="faq" className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-inner border border-indigo-500/20 shadow-indigo-500/10">
                    ...
                    <div className="relative z-10 w-full">
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-3 text-base md:text-lg text-slate-300 max-w-3xl mx-auto">
                                Yapay Zeka Güzellik Salonu Siteniz hakkında aklınıza takılan en yaygın soruları sizin için yanıtladık.
                            </p>
                        </div>
                             ...
                             <div className="relative w-full max-w-[280px] lg:max-w-[360px] aspect-square rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/20 ring-1 ring-white/10 overflow-hidden transform transition-transform duration-500 hover:scale-105 z-10 group">
                                {sliderImages.map((img, index) => (
                                    <img 
                                        key={index}
                                        src={img} 
                                        alt={`Güzellik Salonu Arayüzü ${index + 1}`} 
