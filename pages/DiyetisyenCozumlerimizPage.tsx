...
import DietitianPhoneDialogueSection from "../components/DietitianPhoneDialogueSection";
...
const DiyetisyenCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2020/05/21/40003-424641618_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2021/08/17/85264-589578135_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1498837167922-41c46b10c0e1?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Sağlık Platformu komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. Operasyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Bireysel Diyetisyenler Diyetisyen Çözümleri",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, canlı destek ekibimizin yükünü yarı yarıya azalttı. Artık danışanlerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde danışanlerimize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Satış & Pazarlama Direktörü, İstanbul Business He-ticaret",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Randevu Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile randevu oranımızı ve klinik başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel e-ticareti çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Diyetisyen Çözümlerii",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Bireysel Diyetisyenler diyetisyen sektöründe danışan deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Danışanlerimiz AI satış danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const calculateSavings = useCallback(() => {
    ...
    // The revenue we aim to convert from Sağlık Platformu to Direct
  ...
  const includedServices = [
    {
      icon: "fas fa-he-ticaret",
      title: "AI Diyetisyen Çözümleri Yönetimi (CRM)",
      description:
        "Tüm diyetisyen operasyonlarınızı (randevu, klinik durumu, danışan ilişkileri) tek yerden yönetin.",
      path: "/uygulamalar/diyetisyen-yonetimi-crm",
      features: [
        "Merkezi Danışan Veritabanı",
        "Kişiselleştirilmiş Danışan Deneyimi",
    ...
    },
    {
      ...
      description:
        "Danışanlerinize kişiselleştirilmiş deneyimler sunan, 7/24 randevu alan akıllı bir web sitesi.",
      path: "/yapay-zeka-web/diyetisyen",
      features: [
    ...
    },
    {
      ...
      description:
        "WhatsApp, Instagram gibi kanallardan gelen mesajları otomatik yanıtlayın ve 7/24 satış yapın.",
      path: "/otomasyon/sosyal-medya-otomasyonu",
      features: [
        "Çoklu Kanal (Omnichannel)",
        "DM Kampanyaları & Çapraz Satış",
        "Satış Dönüşüm Takibi",
      ],
    },
    {
      icon: "fas fa-headset",
      title: "Sesli Danışan Hizmetleri",
      description:
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile danışan deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Klinik İçi Sesli Talepler",
    ...
    },
    {
      ...
      features: [
        ...
        "Satış Danışmanı ve Klinik Bilgisi",
        "Fiyat ve Müsaitlik Sorgulama",
      ],
    },
    {
      icon: "fas fa-weightes-stacked",
      title: "Randevu Yönetimi",
      description:
        "Diyetisyen Çözümleriinizin sepet, klinik malzemeleri gibi randevularını anlık takip edin ve randevuleri otomatikleştirin.",
      path: "/otomasyon/randevu-yonetimi-otomasyonu",
      features: [
        "Kritik Randevu Uyarıları",
    ...
    },
    {
      ...
      title: "AI Destekli Randevu Optimizasyonu",
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek klinik fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/diyetisyen-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    {
      name: "Bireysel Diyetisyenler",
      rooms: "5-25 Klinik",
      monthly: 250,
      setup: 1500,
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik e-ticaretler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    },
    {
      ...
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir e-ticaretleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Randevu Optimizasyonu",
        "Özel Danışan Temsilcisi",
        "Öncelikli Destek",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "100+ Klinik & Sağlık Grupları",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük e-ticaretler, kampanya köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Diyetisyen Çözümleri",
        "Özel Destek Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Sağlık Platformu Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Sesli Danışan Hizmetleri",
      butik: "200 dk/ay",
      profesyonel: "500 dk/ay",
      kurumsal: "Özelleştirilmiş",
    },
    {
      name: "AI Randevu Optimizasyonu",
      butik: "Standart",
    ...
    {
      name: "Yerinde Kurulum & Diyetisyen Çözümleri",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın diyetisyen verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut diyetisyen yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok randevu sistemi ve CRM yazılımlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize diyetisyen veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, satış, klinik ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde e-ticaretler düzenliyoruz. Ayrıca sürekli olarak video diyetisyen materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla e-ticareti tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu klinik (multi-property) yönetimini desteklemektedir. Zincir veya grup e-ticaretleri, tüm mülklerinin rezervasyonlarını, randevu oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
      question: "Danışan verilerinin güvenliği nasıl sağlanıyor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz He-ticaretRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) klinik müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Diyetisyen Çözümleri personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde klinik personeliniz klinik görevlerini anlık olarak takip edebilir, canlı destek ekibiniz randevu onay süreci işlemlerini tabletten yapabilir ve yöneticiler diyetisyen performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi e-ticaretimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm danışan verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Web sitenizdeki içeriği ve teklifleri dinamik olarak kişiselleştirin.",
    },
    {
      imageUrl:
      ...
      description:
        "Randevu, gelir ve danışan trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-he-ticaret",
      name: "Bireysel Diyetisyenler Diyetisyen Çözümleriler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Danışanlere 7/24 kesintisiz, birinci klinik birebir asistanlık deneyimi sunar.",
      benefit: "%35 randevu Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir Diyetisyen Çözümlerileri",
      badge: "Maksimum Randevu",
      desc: "Yoğun iş seyahatlerinde hızlı randevu, anlık ödeme ve sıfır kaçan çağrı.",
      benefit: "%85 Personel Verimliliği",
      imageUrl:
        "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-weight",
      name: "Üniversiteler",
      badge: "Zengin Deneyim",
      desc: "Çok dilli klinik servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
      benefit: "%45 Daha Fazla Ek Hizmet Satışı",
      imageUrl:
        "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-carrot",
      name: "Apart Diyetisyen Çözümleriler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır Operasyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1498837167922-41c46b10c0e1?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Kontrol Diyetisyen Çözümleriler",
      badge: "Up-Sell Odaklı",
      desc: "Destek randevuları, kişiye özel kür takipleri ve üyelik programları.",
      benefit: "2.5 Kat Ek Randevu Satışı",
      imageUrl:
        "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
  ];
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Diyetisyen Çözümleri verileriyle AI e-ticareti.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-carrot",
      title: "Diyetisyen Çözümleri & Destek",
      details: [
        "Tüm departmanlara özel diyetisyen.",
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Danışan Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & randevu",
      description:
        "AI destekli web siteniz ve chatbot, danışanleri çeker ve komisyonsuz randevu aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Diyetisyen Çözümleri Öncesi İletişim",
      description:
        "Otomatik e-postalarla danışan beklentisini yönetin ve ek hizmet (upsell) randevuları yapın.",
    },
    {
      icon: "fas fa-apple-alt",
      title: "Diyetisyen Çözümleri Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), klinik servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla danışanlerinizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              <span className="text-sm font-bold tracking-wider text-blue-300 bg-blue-500/20 px-3 py-1.5 rounded-full uppercase">
                DİYETİSYEN ÇÖZÜMLERİ
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                Komisyonları Unutun, <br />{" "}
                <span className="text-blue-400">Danışan Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve danışanlerinize unutulmaz
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanase-ticaret"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Danışan Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, danışanlerinizin e-ticaretinizle ilk temasından, sadık bir
                danışanye dönüşmesine kadar tüm süreci akıllıca ve kesintisiz
                bir şekilde yönetir.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  Diyetisyen Çözümlericiliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
                <p className="mt-1.5 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, e-ticaretinizi geleceğe taşıyacak üç stratejik
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Danışan Deneyimi",
                    description:
                      "Yapay zeka, her danışanye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir e-ticaretlerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Danışan Tercih Havuzu",
                  ...
                  },
                  {
                    ...
                    description:
                      "Hangi danışan segmentinin hangi tekliflere yanıt verdiğini anlayın. Pazarlama bütçenizi tahminlere değil, somut verilere dayalı olarak en kârlı kanallara yönlendirin.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Diyetisyen Çözümleri Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          <strong>Yüksek Komisyonlar:</strong> %15-25 Sağlık Platformu
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Pasif Varlık:</strong> Ziyaretçiyi danışanye
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, randevu ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel danışanler.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Danışan Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, randevu ve danışan verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            randevular ve klinik görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 danışan memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Diyetisyen Çözümleriinizin her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Diyetisyen Çözümleriinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, e-ticaretinizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve danışan sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
                    title: "Sosyal Medya Yöneticisi",
                    role: "Instagram, WhatsApp ve Facebook'taki sohbetleri yönetir, satış fırsatları yaratır.",
                  },
                  {
                    icon: "fas fa-headset",
                    name: "Leo",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Diyetisyen Çözümlericilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, e-ticaretcilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Danışan verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun klinik fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın danışan taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki randevu oranlarını tahmin eder, danışan kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Diyetisyen Çözümleriinizin her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "Danışanlerinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Canlı Destek, klinik ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Diyetisyen Çözümleri hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak danışan memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    ...
                    description:
                      "Danışan taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Diyetisyen Çözümleriiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
        ...
        {/* Danışan İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Danışan İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, e-ticaretlere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm danışan iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Danışanler, uygun tarih ve danışmanlık tiplerini kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Danışan Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, randevu şartları, klinik olanakları, birebir görüşmeler ve analiz hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Diyetisyen Çözümleri başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları danışanlere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve diyetisyen süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-language",
                    title: "Çok Dilli Danışan Desteği",
                    description:
                      "Yabancı uyruklu danışanler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası danışan memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Klinik ve Bölge Bilgilendirmesi",
                    description:
                      "Diyetisyen Çözümleri içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Danışanler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz Satış) Randevuları",
                    description:
                      "Danışanlerin tercihlerine ve ürün tiplerine göre ek premium kontrol, hediye paketi veya uzatılmış garanti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek diyetisyen gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Diyetisyen Çözümleri Sektörü için Mortanas AI?"
          subtitle="Danışan memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm danışan sorularını ve randevu taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Danışan Deneyimi",
              description:
                "Danışanlere klinik olanakları, etüt randevuları ve kulüp sosyal etkinlik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm diyetisyen, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan canlı destek görevlerini otomatize ederek personelinizin daha stratejik ve danışan odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki e-ticaretlerin
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 lg:p-10 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)]">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  Mutlu Diyetisyen Çözümleri{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Yöneticileri
                  </span>
                </h2>
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan e-ticaretlerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)] text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">
                Kliniğinizin Dijital Dönüşümüne{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Bugün Başlayın!
                </span>
              </h2>
              <p className="max-w-2xl mx-auto mb-6 text-xs md:text-sm text-slate-300 leading-relaxed font-medium">
                Uzman ekibimizle görüşerek e-ticaretinizin ihtiyaçlarına özel bir
