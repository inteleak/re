...
import EcommercePhoneDialogueSection from "../components/EcommercePhoneDialogueSection";
...
const ETicaretCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2019/11/17/29168-372990977_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2022/10/24/136323-765039396_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1512406325990-2bdbe7e9d7bd?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
  ...
  const testimonials = [
    {
      ...
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik İşletmeler E-Ticaret",
    ...
    {
      quote:
        "Stok Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile stok oranımızı ve mağaza başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    },
    {
      ...
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak E-Ticareti",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik İşletmeler e-ticaret sektöründe müşteri deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Müşterilerimiz AI satış danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    ...
    },
    {
      ...
      title: "Stok Yönetimi",
      description:
        "E-Ticaretinizin sepet, depo malzemeleri gibi stoklarını anlık takip edin ve siparişleri otomatikleştirin.",
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Stok Optimizasyonu",
    ...
    {
      name: "Kurumsal",
      rooms: "100+ Mağaza & Zincir Mağazalar",
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Yerinde Kurulum & E-Ticaret",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın e-ticaret verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut e-ticaret yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler ERP ve stok yönetimi yazılımlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize e-ticaret veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, satış, depo ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde e-ticaretler düzenliyoruz. Ayrıca sürekli olarak video e-ticaret materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, platformumuz çoklu mağaza (multi-property) yönetimini desteklemektedir. Zincir veya grup e-ticaretleri, tüm mülklerinin rezervasyonlarını, stok oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz He-ticaretRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) mağaza müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "E-Ticaret personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde depo personeliniz depo görevlerini anlık olarak takip edebilir, canlı destek ekibiniz müşteri sipariş/iade süreci işlemlerini tabletten yapabilir ve yöneticiler e-ticaret performansını cepten izleyebilir.",
    },
    {
      question:
  ...
  const platformModules = [
    ...
    },
    {
      ...
      description:
        "Stok, gelir ve müşteri trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-he-ticaret",
      name: "Butik İşletmeler E-Ticaretler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Müşterilere 7/24 kesintisiz, birinci mağaza birebir asistanlık deneyimi sunar.",
      benefit: "%35 Sipariş Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir E-Ticaretleri",
      badge: "Maksimum Stok",
      desc: "Yoğun iş seyahatlerinde hızlı müşteri sipariş, anlık ödeme ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli mağaza servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "E-Ticaret verileriyle AI e-ticareti.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-percent",
      title: "E-Ticaret & Destek",
      details: [
        "Tüm departmanlara özel e-ticaret.",
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Sipariş",
      description:
        "AI destekli web siteniz ve chatbot, müşterileri çeker ve komisyonsuz sipariş aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "E-Ticaret Öncesi İletişim",
      description:
        "Otomatik e-postalarla müşteri beklentisini yönetin ve ek hizmet (upsell) satışları yapın.",
    },
    {
      icon: "fas fa-shopping-cart",
      title: "E-Ticaret Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), mağaza servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              ...
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, müşterilerinizin e-ticaretinizle ilk temasından, sadık bir
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  E-Ticaretciliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
                ...
                {[
                  {
                    ...
                    description:
                      "Yapay zeka, her müşteriye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir e-ticaretlerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  E-Ticaret Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            <strong>Doğrudan Kâr:</strong> 7/24 sipariş alan
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            rezervasyonlar, stok ve müşteri verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            stoklar ve mağaza görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  E-Ticaretinizin her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: E-Ticaretinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    role: "Telefon çağrılarını karşılar, sesli olarak sipariş alır ve personelinizi bilgilendirir.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    name: "Clara",
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun mağaza fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description:
                      "Gelecekteki stok oranlarını tahmin eder, müşteri kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  E-Ticaretinizin her departmanını güçlendirmek için tasarlanmış
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Canlı Destek, depo ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "E-Ticaret hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  E-Ticaretiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: "fas fa-calendar-check",
                    title: "Sipariş Yönetimi Otomasyonu",
                    description:
                      "Müşteriler, uygun tarih ve mağaza tiplerini kolayca görüntüleyerek tek tıkla sipariş oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    ...
                    description:
                      "Yapay zeka asistanımız, sipariş şartları, e-ticaret olanakları, ek etüt saatleri ve kurs hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "E-Ticaret başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları müşterilere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve e-ticaret süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    title: "Mağaza ve Bölge Bilgilendirmesi",
                    description:
                      "E-Ticaret içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Müşteriler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz Satış) Satışları",
                    description:
                      "Müşterilerin tercihlerine ve ürün tiplerine göre ek premium kargo, hediye paketi veya uzatılmış garanti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek e-ticaret gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden E-Ticaret Sektörü için Mortanas AI?"
          ...
          points={[
            {
              ...
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm müşteri sorularını ve sipariş taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Müşteri Deneyimi",
              description:
                "Müşterilere mağaza olanakları, etüt randevuları ve kulüp sosyal etkinlik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm e-ticaret, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan canlı destek görevlerini otomatize ederek personelinizin daha stratejik ve müşteri odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
