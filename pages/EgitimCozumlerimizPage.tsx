...
import EducationalPhoneDialogueSection from "../components/EducationalPhoneDialogueSection";
...
const EgitimCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2020/05/11/38743-424160459_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&q=80&w=2000&auto=format&fit=crop",
    },
    {
      type: "image",
  ...
  const testimonials = [
    {
      ...
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik Okullar Eğitim",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, danışma ekibimizin yükünü yarı yarıya azalttı. Artık öğrencilerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde öğrencilerimize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Satış & Pazarlama Direktörü, İstanbul Business Heğitim",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Kapasite Yönetimi modülü harika. Dinamik fiyatlandırma özelliği ile kontenjan oranımızı ve sınıf başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
      title: "Gelirler Müdürü, Antalya Resort & Etüt",
    ...
    },
    {
      ...
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Eğitimi",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik Okullar eğitim sektöründe öğrenci deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Öğrencilerimiz AI rehberlik özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    {
      icon: "fas fa-heğitim",
      title: "AI Eğitim Yönetimi (CRM)",
      description:
        "Tüm eğitim operasyonlarınızı (kayıt, sınıf durumu, öğrenci ilişkileri) tek yerden yönetin.",
      path: "/uygulamalar/eğitim-yonetimi-crm",
      features: [
        "Merkezi Müşteri Veritabanı",
        "Kişiselleştirilmiş Öğrenci Deneyimi",
    ...
    },
    {
      ...
      description:
        "Öğrencilerinize kişiselleştirilmiş deneyimler sunan, 7/24 kayıt alan akıllı bir web sitesi.",
      path: "/yapay-zeka-web/eğitim",
      features: [
        "Komisyonsuz Kayıt Motoru",
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile öğrenci deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Sınıf İçi Sesli Talepler",
    ...
    },
    {
      ...
      title: "Stok Yönetimi",
      description:
        "Eğitiminizin kantin, temizlik malzemeleri gibi stoklarını anlık takip edin ve siparişleri otomatikleştirin.",
    ...
    },
    {
      ...
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek sınıf fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/eğitim-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    {
      ...
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik eğitimler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    },
    {
      ...
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir eğitimleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    {
      name: "Kurumsal",
      rooms: "100+ Sınıf & Zincir Okullar",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük eğitimler, dönem köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Ders Programı Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın eğitim verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut eğitim yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler ÖBS ve ders programı ile tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra danışma, satış, temizlik ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde eğitimler düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla eğitimi tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu kurum (multi-property) yönetimini desteklemektedir. Zincir veya grup eğitimleri, tüm mülklerinin rezervasyonlarını, kontenjan oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz HeğitimRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) sınıf müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Eğitim personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde temizlik personeliniz temizlik görevlerini anlık olarak takip edebilir, danışma ekibiniz öğrenci kayıt/mezuniyet işlemlerini tabletten yapabilir ve yöneticiler eğitim performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi eğitimimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm öğrenci verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Kontenjan, gelir ve öğrenci trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-heğitim",
      name: "Butik Okullar Eğitimler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Öğrencilere 7/24 kesintisiz, birinci sınıf birebir asistanlık deneyimi sunar.",
      benefit: "%35 Kayıt Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir Eğitimleri",
      badge: "Maksimum Kontenjan",
      desc: "Yoğun iş seyahatlerinde hızlı öğrenci kayıt, anlık ödeme ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli sınıf servisi, dinamik yemekhane rezervasyonu ve aktivite planlama.",
    ...
    },
    {
      ...
      desc: "Etüt randevuları, kişiye özel kür takipleri ve üyelik programları.",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Öğrenci Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Kayıt",
      description:
        "AI destekli web siteniz ve chatbot, öğrencileri çeker ve komisyonsuz kayıt aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Eğitim Öncesi İletişim",
      description:
        "Otomatik e-postalarla öğrenci beklentisini yönetin ve ek hizmet (upsell) satışları yapın.",
    },
    {
      icon: "fas fa-graduation-cap",
      title: "Eğitim Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), sınıf servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla öğrencilerinizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                ...
                <span className="text-blue-400">Öğrenci Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve öğrencilerinize unutulmaz
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanaseğitim"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Öğrenci Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, öğrencilerinizin eğitiminizle ilk temasından, sadık bir
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Öğrenci Deneyimi",
                    description:
                      "Yapay zeka, her öğrenciye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir eğitimlerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Öğrenci Tercih Havuzu",
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Eğitim Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 md:p-6 rounded-[1.5rem] border-2 border-red-500/20 shadow-xl shadow-red-900/10 relative overflow-hidden group hover:border-red-500/40 transition-colors duration-500">
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, stok ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel öğrenciler.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            <strong>Doğrudan Kâr:</strong> 7/24 kayıt alan
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Öğrenci Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, stok ve öğrenci verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            stoklar ve sınıf görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 öğrenci memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Eğitiminizin her departmanını güçlendirmek için tasarlanmış 9
        ...
        <EducationalPhoneDialogueSection />
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Eğitiminizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, eğitiminizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    name: "Alex",
                    title: "Kayıt Uzmanı",
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve öğrenci sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
                  ...
                  },
                  {
                    ...
                    role: "Telefon çağrılarını karşılar, sesli olarak kayıt alır ve personelinizi bilgilendirir.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    name: "Clara",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Eğitimcilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, eğitimcilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Öğrenci verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun sınıf fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın öğrenci taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki kontenjan oranlarını tahmin eder, öğrenci kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Eğitiminizin her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "Öğrencilerinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Danışma, temizlik ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Eğitim hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak öğrenci memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    ...
                    description:
                      "Öğrenci taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Eğitiminiz için uyarlanmış 9 farklı yazılım ve yapay zeka
        ...
        {/* Öğrenci İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Öğrenci İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, eğitimlere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm öğrenci iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: "fas fa-calendar-check",
                    title: "Kayıt Yönetimi Otomasyonu",
                    description:
                      "Öğrenciler, uygun tarih ve sınıf tiplerini kolayca görüntüleyerek tek tıkla kayıt oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Öğrenci Sorularına Anında Yanıt",
                    description:
                  ...
                  },
                  {
                    ...
                    title: "Çok Dilli Öğrenci Desteği",
                    description:
                      "Yabancı uyruklu öğrenciler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası öğrenci memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Kurum ve Bölge Bilgilendirmesi",
                    description:
                      "Eğitim içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Öğrenciler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Ek Program) Satışları",
                    description:
        ...
        <WhyMortanasSection
          ...
          subtitle="Öğrenci memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm öğrenci sorularını ve kayıt taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Öğrenci Deneyimi",
              description:
            ...
            },
            {
              ...
              description:
                "Tüm eğitim, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan danışma görevlerini otomatize ederek personelinizin daha stratejik ve öğrenci odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki eğitimlerin
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan eğitimlerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
