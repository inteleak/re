...
import RealEstatePhoneDialogueSection from "../components/RealEstatePhoneDialogueSection";
...
const EmlakciCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2021/11/02/95958-648171097_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1560518883-ce09059ee41F?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2021/04/16/71337-537449553_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Pazaryeri komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. Operasyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Bağımsız Danışmanlar Emlakçı Çözümleri",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, canlı destek ekibimizin yükünü yarı yarıya azalttı. Artık alıcı ve kiracılarımizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde alıcı ve kiracılarımize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
    ...
    {
      quote:
        "Portföy Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile portföy oranımızı ve ofis başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    },
    {
      ...
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Emlakçı Çözümlerii",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Bağımsız Danışmanlar emlakçı sektöründe alıcı/kiracı deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. alıcı ve kiracılarımiz AI satış danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    ...
    {
      icon: "fas fa-headset",
      title: "Sesli Alıcı/Kiracı Hizmetleri",
      description:
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile alıcı/kiracı deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Ofis İçi Sesli Talepler",
    ...
    {
      icon: "fas fa-buildinges-stacked",
      title: "Portföy Yönetimi",
      description:
        "Emlakçı Çözümleriinizin sepet, bölge malzemeleri gibi portföylarını anlık takip edin ve randevuleri otomatikleştirin.",
      path: "/otomasyon/portföy-yonetimi-otomasyonu",
      features: [
        "Kritik Portföy Uyarıları",
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Portföy Optimizasyonu",
        "Özel Alıcı/Kiracı Temsilcisi",
        "Öncelikli Destek",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "100+ Ofis & Kurumsal Emlak Ofisleri",
      ...
      features: [
        ...
        "Özel API Erişimi",
        "Yerinde Kurulum & Emlakçı Çözümleri",
        "Özel Destek Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "İlan Portalı Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Sesli Alıcı/Kiracı Hizmetleri",
      butik: "200 dk/ay",
      profesyonel: "500 dk/ay",
      kurumsal: "Özelleştirilmiş",
    },
    {
      name: "AI Portföy Optimizasyonu",
      butik: "Standart",
    ...
    {
      name: "Özel Alıcı/Kiracı Temsilcisi",
      butik: false,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Yerinde Kurulum & Emlakçı Çözümleri",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın emlakçı verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut emlakçı yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok Re-Os, Zingat, Sahibinden ve Hepsiemlak gibi portallarla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize emlakçı veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, satış, bölge ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde e-ticaretler düzenliyoruz. Ayrıca sürekli olarak video emlakçı materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, platformumuz çoklu ofis (multi-property) yönetimini desteklemektedir. Zincir veya grup e-ticaretleri, tüm mülklerinin rezervasyonlarını, portföy oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
      question: "Alıcı/Kiracı verilerinin güvenliği nasıl sağlanıyor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz He-ticaretRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) ofis müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Emlakçı Çözümleri personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde saha personeliniz saha görevlerini anlık olarak takip edebilir, canlı destek ekibiniz satış/kiralama süreci işlemlerini tabletten yapabilir ve yöneticiler emlakçı performansını cepten izleyebilir.",
    },
    {
      question:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm alıcı/kiracı verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Portföy, gelir ve alıcı/kiracı trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-he-ticaret",
      name: "Bağımsız Danışmanlar Emlakçı Çözümleriler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Alıcı/Kiracılere 7/24 kesintisiz, birinci ofis birebir asistanlık deneyimi sunar.",
      benefit: "%35 randevu Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1560518883-ce09059ee41F?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir Emlakçı Çözümlerileri",
      badge: "Maksimum Portföy",
      desc: "Yoğun iş seyahatlerinde hızlı alıcı/kiracı randevu, anlık ödeme ve sıfır kaçan çağrı.",
      benefit: "%85 Personel Verimliliği",
      imageUrl:
        "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Üniversiteler",
      badge: "Zengin Deneyim",
      desc: "Çok dilli ofis servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
      benefit: "%45 Daha Fazla Ek Hizmet Satışı",
      imageUrl:
        "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-key",
      name: "Apart Emlakçı Çözümleriler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır Operasyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Tapu/Kontrat Emlakçı Çözümleriler",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Emlakçı Çözümleri verileriyle AI e-ticareti.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-key",
      title: "Emlakçı Çözümleri & Destek",
      details: [
        "Tüm departmanlara özel emlakçı.",
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Alıcı/Kiracı Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & randevu",
      description:
        "AI destekli web siteniz ve chatbot, alıcı ve kiracıları çeker ve komisyonsuz randevu aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Emlakçı Çözümleri Öncesi İletişim",
      description:
        "Otomatik e-postalarla alıcı/kiracı beklentisini yönetin ve ek hizmet (upsell) satış/kiralamaları yapın.",
    },
    {
      icon: "fas fa-home",
      title: "Emlakçı Çözümleri Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), ofis servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla alıcı ve kiracılarınizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                ...
                <span className="text-blue-400">Alıcı/Kiracı Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve alıcı ve kiracılarınıza unutulmaz
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Alıcı/Kiracı Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, alıcı ve kiracılarınizin e-ticaretinizle ilk temasından, sadık bir
                alıcı/kiracıye dönüşmesine kadar tüm süreci akıllıca ve kesintisiz
                bir şekilde yönetir.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  Emlakçı Çözümlericiliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Alıcı/Kiracı Deneyimi",
                    description:
                      "Yapay zeka, her alıcı/kiracıye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir e-ticaretlerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Alıcı/Kiracı Tercih Havuzu",
                  ...
                  },
                  {
                    ...
                    description:
                      "Hangi alıcı/kiracı segmentinin hangi tekliflere yanıt verdiğini anlayın. Pazarlama bütçenizi tahminlere değil, somut verilere dayalı olarak en kârlı kanallara yönlendirin.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Emlakçı Çözümleri Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 md:p-6 rounded-[1.5rem] border-2 border-red-500/20 shadow-xl shadow-red-900/10 relative overflow-hidden group hover:border-red-500/40 transition-colors duration-500">
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Pasif Varlık:</strong> Ziyaretçiyi alıcı/kiracıye
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, portföy ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel alıcı/kiracıler.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Alıcı/Kiracı Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, portföy ve alıcı/kiracı verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            portföylar ve ofis görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 alıcı/kiracı memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Emlakçı Çözümleriinizin her departmanını güçlendirmek için tasarlanmış 9
        ...
        <RealEstatePhoneDialogueSection />
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Emlakçı Çözümleriinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                ...
                {[
                  {
                    ...
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve alıcı/kiracı sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Emlakçı Çözümlericilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                ...
                {[
                  {
                    ...
                    description:
                      "Alıcı/Kiracı verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun ofis fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın alıcı/kiracı taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki portföy oranlarını tahmin eder, alıcı/kiracı kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Emlakçı Çözümleriinizin her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "alıcı ve kiracılarınizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Canlı Destek, bölge ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Emlakçı Çözümleri hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak alıcı/kiracı memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    ...
                    description:
                      "Alıcı/Kiracı taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Emlakçı Çözümleriiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
        ...
        {/* Alıcı/Kiracı İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Alıcı/Kiracı İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, e-ticaretlere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm alıcı/kiracı iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Alıcı/Kiracıler, uygun tarih ve gayrimenkul tiplerini kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Alıcı/Kiracı Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, randevu şartları, ofis olanakları, site aidatları ve tapu hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Emlakçı Çözümleri başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları alıcı/kiracılere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve emlakçı süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-language",
                    title: "Çok Dilli Alıcı/Kiracı Desteği",
                    description:
                      "Yabancı uyruklu alıcı/kiracıler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası alıcı/kiracı memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Ofis ve Bölge Bilgilendirmesi",
                    description:
                      "Emlakçı Çözümleri içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Alıcı/Kiracıler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz Satış) Satış/Kiralamaları",
                    description:
                      "alıcı ve kiracıların tercihlerine ve ürün tiplerine göre ek premium tapu/kontrat, hediye paketi veya uzatılmış garanti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek emlakçı gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Emlakçı Çözümleri Sektörü için Mortanas AI?"
          subtitle="Alıcı/Kiracı memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm alıcı/kiracı sorularını ve randevu taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Alıcı/Kiracı Deneyimi",
              description:
                "Alıcı/Kiracılere ofis olanakları, etüt randevuları ve kulüp sosyal etkinlik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm emlakçı, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan canlı destek görevlerini otomatize ederek personelinizin daha stratejik ve alıcı/kiracı odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
