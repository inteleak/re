...
import FitnessPhoneDialogueSection from "../components/FitnessPhoneDialogueSection";
...
const FitnessCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2016/08/22/4741-178550757_tiny.mp4",
    },
    {
      type: "image",
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Pazaryeri komisyonlarımız %80 azaldı ve doğrudan randevularımız tavan yaptı. Operasyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik Stüdyolar Fitness Çözümleri",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, canlı destek ekibimizin yükünü yarı yarıya azalttı. Artık üyelerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde üyelerimize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Randevu & Pazarlama Direktörü, FitLife Sports Club",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Ekipman Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile ekipman oranımızı ve spor salonu başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    },
    {
      ...
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Fitness Çözümlerii",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik Stüdyolar fitness sektöründe üye deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Üyelerimiz AI randevu danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    ...
    },
    {
      ...
      features: [
        ...
        "Spor Salonu İçi Sesli Talepler",
    ...
    },
    {
      ...
      description:
        "Spor Salonuınızın sepet, salon malzemeleri gibi ekipmanlarını anlık takip edin ve rezervasyonleri otomatikleştirin.",
      path: "/otomasyon/ekipman-yonetimi-otomasyonu",
      features: [
        "Kritik Ekipman Uyarıları",
  ...
  const pricingTiers = [
    {
      name: "Butik Stüdyolar",
      rooms: "5-25 Spor Salonu",
      monthly: 250,
      setup: 1500,
      popular: false,
      isEnterprise: false,
    ...
    },
    {
      ...
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Ekipman Optimizasyonu",
        "Özel Üye Temsilcisi",
        "Öncelikli Destek",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "Popüler Spor Salonları",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük salonlar, spor kompleksleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Fitness Çözümleri",
        "Özel Destek Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Antrenman Platformu Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Yerinde Kurulum & Fitness Çözümleri",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın spor salonu verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut spor salonu yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
    ...
    {
      question: "Ekibimize spor salonu veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, randevu, salon ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde salonlar düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, platformumuz çoklu spor salonu (multi-property) yönetimini desteklemektedir. Zincir veya grup salonları, tüm mülklerinin randevularını, ekipman oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz FitnessRunner, SiteMinder gibi sektörün önde gelen salon yönetim yazılımlarıyla tam entegre çalışır. Bu sayede tüm online randevu kanallarınızdaki (Mindbody, ClassPass vb.) spor salonu müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Fitness Çözümleri personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde salon personeliniz salon görevlerini anlık olarak takip edebilir, canlı destek ekibiniz üye üyelik/kayıt süreci işlemlerini tabletten yapabilir ve yöneticiler spor salonu performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi salonumizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    ...
    },
    {
      ...
      description:
        "Ekipman, gelir ve üye trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-Fitness",
      name: "Butik Stüdyolar Fitness Çözümleriler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Üyelere 7/24 kesintisiz, birinci spor salonu birebir asistanlık deneyimi sunar.",
    ...
    },
    {
      ...
      name: "Şehir Fitness Çözümlerileri",
      badge: "Maksimum Ekipman",
    ...
    },
    {
      ...
      desc: "Çok dilli spor salonu servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
    ...
    {
      icon: "fas fa-fire",
      name: "Apart Fitness Çözümleriler",
      badge: "Tam Otomasyon",
    ...
    {
      icon: "fas fa-spa",
      name: "Online Eğitim Fitness Çözümleriler",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Fitness Çözümleri verileriyle AI salonu.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-fire",
      title: "Fitness Çözümleri & Destek",
      details: [
        "Tüm departmanlara özel spor salonu.",
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Randevu",
      description:
        "AI destekli web siteniz ve chatbot, üyeleri çeker ve komisyonsuz randevu aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Fitness Çözümleri Öncesi İletişim",
      description:
        "Otomatik e-postalarla üye beklentisini yönetin ve ek hizmet (upsell) rezervasyonları yapın.",
    },
    {
      icon: "fas fa-dumbbell",
      title: "Fitness Çözümleri Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), spor salonu servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla üyelerinizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve Üyelerinize unutulmaz
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanasfitness"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              ...
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, üyelerinizin salonunizle ilk temasından, sadık bir
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  Fitness Çözümlericiliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
                <p className="mt-1.5 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, salonunizi geleceğe taşıyacak üç stratejik
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Fitness Çözümleri Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 md:p-6 rounded-[1.5rem] border-2 border-red-500/20 shadow-xl shadow-red-900/10 relative overflow-hidden group hover:border-red-500/40 transition-colors duration-500">
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, ekipman ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel üyeler.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            rezervasyonlar, ekipman ve üye verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            malzemelar ve spor salonu görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Spor Salonuınızın her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Spor Salonuınızın Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, salonunizin farklı departmanları için uzmanlaşmış
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Fitness Çözümlericilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, fitness sektörü için özel olarak
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun spor salonu fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description:
                      "Gelecekteki ekipman oranlarını tahmin eder, üye kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Spor Salonuınızın her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "üyelerinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                  ...
                  },
                  {
                    ...
                    description:
                      "Fitness Çözümleri hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Fitness Çözümleriiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
                ...
                {[
                  {
                    ...
                    description:
                      "Üyeler, uygun tarih ve ders programlarını kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    ...
                    description:
                      "Yapay zeka asistanımız, randevu şartları, spor salonu olanakları, çalışma saatleri ve özel menü hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Fitness Çözümleri başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları üyelere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve spor salonu süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    ...
                    description:
                      "Yabancı uyruklu üyeler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası üye memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Spor Salonu ve Bölge Bilgilendirmesi",
                    description:
                      "Fitness Çözümleri içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Üyeler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    ...
                    description:
                      "üyelerin tercihlerine ve antrenman tiplerine göre ek premium PT hizmeti, supplement paketi veya diyetisyen danışmanlığı gibi ek hizmetleri doğru zamanda akıllıca teklif ederek spor salonu gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Fitness Çözümleri Sektörü için Mortanas AI?"
          ...
          points={[
            ...
            },
            {
              ...
              description:
                "Üyelere spor salonu olanakları, grup dersleri ve özel etkinlik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm spor salonu, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)] text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto mb-6 text-xs md:text-sm text-slate-300 leading-relaxed font-medium">
                Uzman ekibimizle görüşerek salonunizin ihtiyaçlarına özel bir
