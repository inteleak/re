...
import LawPhoneDialogueSection from "../components/LawPhoneDialogueSection";
...
const HukukCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2020/04/18/36511-412239327_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2020/12/13/59389-495247854_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1505664125541-25c9cece15af?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1589903308904-1010c2294adc?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Hukuk Portalı komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. DMSsyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik Bürolar Hukuk",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, asistan avukat ekibimizin yükünü yarı yarıya azalttı. Artık müvekkillerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde müvekkillerimize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Randevu & Pazarlama Direktörü, İstanbul Business Hukuk",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "İş Yükü Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile dosya yükü oranımızı ve büro başına gelirimizi optimize etmeyi başardık. Raporlama dava dosyalarıı çok detaylı.",
      name: "Ahmet Çelik",
      title: "Gelirler Müdürü, Antalya Resort & Danışmanlık",
      avatarUrl: "https://randomuser.me/api/portraits/men/45.jpg",
    },
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel hukuki çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "DMSsyon Yöneticisi, Uludağ Kayak Hukuki",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik Bürolar hukuk sektöründe müvekkil deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Müvekkillerimiz AI asistan avukat özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const calculateSavings = useCallback(() => {
    ...
    // The revenue we aim to convert from Hukuk Portalı to Direct
  ...
  const includedServices = [
    {
      icon: "fas fa-hhukuk",
      title: "AI Hukuk Yönetimi (CRM)",
      description:
        "Tüm hukuk operasyonlarınızı (randevu, büro durumu, müvekkil ilişkileri) tek yerden yönetin.",
      path: "/uygulamalar/hukuk-yonetimi-crm",
      features: [
        "Merkezi Müvekkil Veritabanı",
        "Kişiselleştirilmiş Müvekkil Deneyimi",
    ...
    },
    {
      ...
      description:
        "Müvekkillerinize kişiselleştirilmiş deneyimler sunan, 7/24 randevu alan akıllı bir web sitesi.",
      path: "/yapay-zeka-web/hukuk",
      features: [
    ...
    {
      icon: "fas fa-headset",
      title: "Sesli Müvekkil Hizmetleri",
      description:
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile müvekkil deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Büro İçi Sesli Talepler",
    ...
    },
    {
      ...
      features: [
        ...
        "Asistan Avukat ve Büro Bilgisi",
        "Fiyat ve Müsaitlik Sorgulama",
      ],
    },
    {
      icon: "fas fa-gaveles-stacked",
      title: "Dava Takibi",
      description:
        "Hukukinizin teklif, hukuk bürosu malzemeleri gibi stoklarını anlık takip edin ve randevuleri otomatikleştirin.",
      path: "/otomasyon/dosya yükü-yonetimi-otomasyonu",
      features: [
        "Kritik Dosya Yükü Uyarıları",
    ...
    },
    {
      ...
      title: "AI Destekli İş Yükü Optimizasyonu",
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek büro fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/hukuk-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    {
      ...
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik hukukler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    },
    {
      ...
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir hukukleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI İş Yükü Optimizasyonu",
        "Özel Müvekkil Temsilcisi",
        "Öncelikli Danışmanlık",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "100+ Büro & Hukuk Grupları",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük hukukler, seminer/eğitim köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Hukuk",
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Hukuk Portalı Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Sesli Müvekkil Hizmetleri",
      butik: "200 dk/ay",
      profesyonel: "500 dk/ay",
      kurumsal: "Özelleştirilmiş",
    },
    {
      name: "AI İş Yükü Optimizasyonu",
      butik: "Standart",
    ...
    { type: "heading", name: "Danışmanlık & Hizmetler" },
    {
      name: "Özel Müvekkil Temsilcisi",
      butik: false,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Yerinde Kurulum & Hukuk",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
    {
      name: "7/24 Danışmanlık",
      butik: "Standart",
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın hukuk verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut hukuk yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, DMS, Dealer Management System gibi birçok popüler ERP ve dava takibi yazılımlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize hukuk veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra asistan avukat, randevu, hukuk bürosu ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde eğitimler düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
      question: "Danışmanlık hizmetleriniz neleri kapsıyor?",
      answer:
    ...
    {
      question: "Birden fazla hukuki tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu büro (multi-property) yönetimini desteklemektedir. Zincir veya grup hukukleri, tüm mülklerinin rezervasyonlarını, dosya yükü oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
      question: "Müvekkil verilerinin güvenliği nasıl sağlanıyor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz Salesforce, SAP, Microsoft Dynamics gibi sektörün önde gelen ERP ve CRM sistemleriyle tam entegre çalışır. Bu sayede tüm online randevu kanallarınızdaki (Booking, Expedia, Airbnb vb.) büro müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Hukuk personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde büro personeliniz ofis görevlerini anlık olarak takip edebilir, asistan avukat ekibiniz müvekkil randevu/servis süreci işlemlerini tabletten yapabilir ve yöneticiler büro performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi hukukimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm müvekkil verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Dosya Yükü, gelir ve müvekkil trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-hhukuk",
      name: "Butik Bürolar Hukukler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Müvekkillere 7/24 kesintisiz, birinci büro birebir asistanlık deneyimi sunar.",
    ...
    },
    {
      ...
      name: "Şehir Hukukleri",
      badge: "Maksimum Dosya Yükü",
      desc: "Yoğun dava dönemlerinde hızlı ön görüşme planlama ve sıfır kaçan çağrı.",
      benefit: "%85 Personel Verimliliği",
      imageUrl:
        "https://images.unsplash.com/photo-1505664125541-25c9cece15af?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-gavel",
      name: "Üniversiteler",
      badge: "Zengin Deneyim",
      desc: "Çok dilli büro servisi, dinamik vekaletname alımı rezervasyonu ve aktivite planlama.",
    ...
    },
    {
      ...
      benefit: "Sıfır DMSsyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1589903308904-1010c2294adc?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Ön Görüşme Hukukler",
      badge: "Up-Sell Odaklı",
      desc: "Danışmanlık randevuları, kişiye özel kür takipleri ve üyelik programları.",
      benefit: "2.5 Kat Ek Randevu Randevuı",
      imageUrl:
        "https://images.unsplash.com/photo-1512406325990-2bdbe7e9d7bd?auto=format&fit=crop&w=600&q=80",
    },
  ];
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Müvekkil Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Randevu",
      description:
        "AI destekli web siteniz ve chatbot, müvekkilleri çeker ve komisyonsuz randevu aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Hukuk Öncesi İletişim",
      description:
        "Otomatik e-postalarla müvekkil beklentisini yönetin ve ek hizmet (upsell) randevuları yapın.",
    },
    {
      icon: "fas fa-balance-scale",
      title: "Hukuk Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), büro servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla müvekkillerinizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                ...
                <span className="text-blue-400">Müvekkil Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve müvekkillerinize unutulmaz
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanashukuk"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Müvekkil Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, müvekkillerinizin büronizle ilk temasından, sadık bir
                müvekkilye dönüşmesine kadar tüm süreci akıllıca ve kesintisiz
                bir şekilde yönetir.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Müvekkil Deneyimi",
                    description:
                      "Yapay zeka, her müvekkilye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir bürolerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Müvekkil Tercih Havuzu",
                  ...
                  },
                  {
                    ...
                    description:
                      "Hangi müvekkil segmentinin hangi tekliflere yanıt verdiğini anlayın. Pazarlama bütçenizi tahminlere değil, somut verilere dayalı olarak en kârlı kanallara yönlendirin.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Hukuk Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          <strong>Yüksek Komisyonlar:</strong> %15-25 Hukuk Portalı
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Pasif Varlık:</strong> Ziyaretçiyi müvekkilye
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, dosya yükü ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel müvekkiller.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Manuel DMSsyon:</strong> Sayım ve görev
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Müvekkil Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, dosya yükü ve müvekkil verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            <strong>Akıllı DMSsyon:</strong> Kritik seviyedeki
                            stoklar ve büro görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 müvekkil memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Hukukinizin her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Hukukinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, hukukinizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve müvekkil sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Hukukcilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, hukukcilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Müvekkil verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun büro fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın müvekkil taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki dosya yükü oranlarını tahmin eder, müvekkil kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Hukukinizin her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "Müvekkillerinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Canlı Danışmanlık, hukuk bürosu ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Hukuk hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak müvekkil memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    title: "Güçlü Danışmanlık Deneyimi",
                    description:
                      "Müvekkil taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Hukukiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  1 ay boyunca geçerli %40 özel danışmanlık ile tüm yıl masraflar
        ...
        {/* Müvekkil İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Müvekkil İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, hukuklere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm müvekkil iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Müvekkiller, uygun tarih ve dava tiplerine kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Müvekkil Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, randevu şartları, büro hizmetleri, kampanyalar ve servis hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Dava teslimat detayları, ön görüşme tarihleri ve dosya teslim tarihleri müvekkillere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve randevu süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-language",
                    title: "Çok Dilli Müvekkil Desteği",
                    description:
                      "Yabancı uyruklu müvekkiller için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası müvekkil memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Büro ve Bölge Bilgilendirmesi",
                    description:
                      "Dava donanım paketleri, ödeme seçenekleri, danışmanlık olanakları ve garanti imkanları hakkında bilgilendirici içerikler anında sunulur. Müvekkiller tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz Randevu) Randevuları",
                    description:
                      "Müvekkillerin tercihlerine ve dava tiplerine göre arabuluculuk, sözleşme hazırlama veya temsil hizmeti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek büro gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          ...
          subtitle="Müvekkil memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm müvekkil sorularını ve randevu taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Müvekkil Deneyimi",
              description:
                "Müvekkillere büro olanakları, ön görüşme randevuları ve yeni kampanya önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm hukuk, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan asistan avukat görevlerini otomatize ederek personelinizin daha stratejik ve müvekkil odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki hukuklerin
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan hukuklerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
