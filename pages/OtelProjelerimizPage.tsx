...
import DualPhoneDialogueSection from "../components/DualPhoneDialogueSection";
...
const OtelCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2018/06/25/16933-277180295_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1551882547-ff40c0d509af?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1522798514397-e04e123610e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde OTA komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. Operasyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik Otel",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, resepsiyon ekibimizin yükünü yarı yarıya azalttı. Artık misafirlerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    },
    {
      ...
      name: "Canan Demir",
      title: "Satış & Pazarlama Direktörü, İstanbul Business Hotel",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Gelir yönetimi modülü harika. Dinamik fiyatlandırma özelliği ile doluluk oranımızı ve oda başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
      title: "Gelirler Müdürü, Antalya Resort & Spa",
    ...
    },
    {
      ...
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Oteli",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik otelcilikte misafir deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Misafirlerimiz AI konsiyerj özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    {
      icon: "fas fa-hotel",
      title: "AI Otel Yönetimi (CRM)",
      description:
        "Tüm otel operasyonlarınızı (rezervasyon, oda durumu, misafir ilişkileri) tek yerden yönetin.",
    ...
    },
    {
      ...
      title: "Stok Yönetimi",
      description:
        "Otelinizin minibar, temizlik malzemeleri gibi stoklarını anlık takip edin ve siparişleri otomatikleştirin.",
    ...
    },
    {
      ...
      title: "AI Destekli Gelir Yönetimi",
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek oda fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/otel-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir otelleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Gelir Yönetimi",
    ...
    },
    {
      ...
      isEnterprise: true,
      description:
        "Büyük oteller, tatil köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Kanal Yöneticisi Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın otel verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut otel yönetim yazılımım (PMS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler PMS ve kanal yöneticisi ile tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra resepsiyon, satış, kat hizmetleri ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde eğitimler düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla oteli tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu tesis (multi-property) yönetimini desteklemektedir. Zincir veya grup otelleri, tüm mülklerinin rezervasyonlarını, doluluk oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz HotelRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) oda müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Otel personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde kat hizmetleri personeliniz temizlik görevlerini anlık olarak takip edebilir, resepsiyon ekibiniz check-in/check-out işlemlerini tabletten yapabilir ve yöneticiler otel performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi otelimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    ...
    },
    {
      ...
      description:
        "Doluluk, gelir ve misafir trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      ...
      desc: "Misafirlere 7/24 kesintisiz, birinci sınıf birebir asistanlık deneyimi sunar.",
    ...
    },
    {
      ...
      name: "Şehir Otelleri",
      badge: "Maksimum Doluluk",
      desc: "Yoğun iş seyahatlerinde hızlı check-in, anlık ödeme ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli oda servisi, dinamik restoran rezervasyonu ve aktivite planlama.",
    ...
    },
    {
      ...
      desc: "Spa randevuları, kişiye özel kür takipleri ve üyelik programları.",
  ...
  const guestJourneySteps = [
    ...
    },
    {
      ...
      title: "Konaklama Öncesi İletişim",
      description:
        "Otomatik e-postalarla misafir beklentisini yönetin ve ek hizmet (upsell) satışları yapın.",
    },
    {
      icon: "fas fa-concierge-bell",
      title: "Konaklama Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), oda servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanasotel"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              ...
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, misafirinizin otelinizle ilk temasından, sadık bir
                ...
                {[
                  {
                    ...
                    description:
                      "Yapay zeka, her misafire adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir otellerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Otel Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          <strong>Yüksek Komisyonlar:</strong> %15-25 OTA
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> PMS, stok ve diğer
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş RevPAR.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, stok ve misafir verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            stoklar ve oda görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Otelinizin her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Otelinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, otelinizin farklı departmanları için uzmanlaşmış
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Otelcilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, otelcilik sektörü için özel olarak
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun oda fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description:
                      "Gelecekteki doluluk oranlarını tahmin eder, misafir kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Otelinizin her departmanını güçlendirmek için tasarlanmış
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Resepsiyon, kat hizmetleri ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Otel hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Oteliniz için uyarlanmış 9 farklı yazılım ve yapay zeka
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                ...
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, otellere hız, esneklik ve 7/24 hizmet imkânı
                ...
                {[
                  {
                    ...
                    description:
                      "Misafirler, uygun tarih ve oda tiplerini kolayca görüntüleyerek tek tıkla rezervasyon oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    ...
                    description:
                      "Yapay zeka asistanımız, rezervasyon şartları, otel olanakları, restoran saatleri ve SPA hizmetleri gibi konularda 7/24 anında yanıt verir. Resepsiyona gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Konaklama öncesi giriş detayları, havaalanı transferleri ve restoran rezervasyonları misafirlere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve konaklama süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    title: "Tesis ve Bölge Bilgilendirmesi",
                    description:
                      "Otel içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Misafirler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Upsell) Satışları",
                    description:
                      "Misafirlerin tercihlerine ve konaklama tiplerine göre oda yükseltme, SPA veya özel akşam yemeği gibi ek hizmetleri doğru zamanda akıllıca teklif ederek otel gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Otel Sektörü için Mortanas AI?"
          ...
          points={[
            ...
            },
            {
              ...
              description:
                "Misafirlere tesis olanakları, restoran rezervasyonları ve çevre gezi önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm konaklama, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan resepsiyon görevlerini otomatize ederek personelinizin daha stratejik ve misafir odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki otellerin
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan otellerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
