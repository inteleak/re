...
import AutomotivePhoneDialogueSection from "../components/AutomotivePhoneDialogueSection";
...
const OtomotivCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2016/09/21/5361-182390317_tiny.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1620012253245-c529ce153d82?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Otomobil Portalı komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. DMSsyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Özel Servisler Otomotiv",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, satış danışmanı ekibimizin yükünü yarı yarıya azalttı. Artık müşterilerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    },
    {
      ...
      name: "Canan Demir",
      title: "Satış & Pazarlama Direktörü, İstanbul Business Otomotiv",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Filo Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile araç stoğu oranımızı ve bayi başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
      title: "Gelirler Müdürü, Antalya Resort & Servis",
      avatarUrl: "https://randomuser.me/api/portraits/men/45.jpg",
    },
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel otomotivi çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "DMSsyon Yöneticisi, Uludağ Kayak Otomotivi",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Özel Servisler otomotiv sektöründe müşteri deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Müşterilerimiz AI satış danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const calculateSavings = useCallback(() => {
    ...
    // The revenue we aim to convert from Otomobil Portalı to Direct
  ...
  const includedServices = [
    {
      icon: "fas fa-hotomotiv",
      title: "AI Otomotiv Yönetimi (CRM)",
      description:
        "Tüm otomotiv operasyonlarınızı (satış, bayi durumu, müşteri ilişkileri) tek yerden yönetin.",
    ...
    },
    {
      ...
      path: "/yapay-zeka-web/otomotiv",
      features: [
        "Komisyonsuz Satış Motoru",
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile müşteri deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Bayi İçi Sesli Talepler",
    ...
    {
      icon: "fas fa-toolses-stacked",
      title: "Araç Envanteri",
      description:
        "Otomotivinizin teklif, galeri malzemeleri gibi stoklarını anlık takip edin ve randevuleri otomatikleştirin.",
      path: "/otomasyon/araç stoğu-yonetimi-otomasyonu",
      features: [
        "Kritik Araç Stoğu Uyarıları",
    ...
    },
    {
      ...
      title: "AI Destekli Filo Optimizasyonu",
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek bayi fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/otomotiv-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    {
      ...
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik otomotivler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    },
    {
      ...
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir otomotivleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Filo Optimizasyonu",
    ...
    {
      name: "Kurumsal",
      rooms: "100+ Bayi & Otomotiv Grupları",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük otomotivler, lansman köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Otomotiv",
        "Özel Servis Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Otomobil Portalı Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    { type: "heading", name: "Servis & Hizmetler" },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın otomotiv verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut otomotiv yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, DMS, Dealer Management System gibi birçok popüler ERP ve araç envanteri yazılımlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize otomotiv veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra satış danışmanı, satış, galeri ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde eğitimler düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
      question: "Servis hizmetleriniz neleri kapsıyor?",
      answer:
    ...
    {
      question: "Birden fazla otomotivi tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu bayi (multi-property) yönetimini desteklemektedir. Zincir veya grup otomotivleri, tüm mülklerinin rezervasyonlarını, araç stoğu oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz Salesforce, SAP, Microsoft Dynamics gibi sektörün önde gelen ERP ve CRM sistemleriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) bayi müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Otomotiv personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde galeri personeliniz galeri görevlerini anlık olarak takip edebilir, satış danışmanı ekibiniz müşteri satış/servis süreci işlemlerini tabletten yapabilir ve yöneticiler bayi performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi otomotivimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm müşteri verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Araç Stoğu, gelir ve müşteri trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-hotomotiv",
      name: "Özel Servisler Otomotivler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Müşterilere 7/24 kesintisiz, birinci bayi birebir asistanlık deneyimi sunar.",
    ...
    },
    {
      ...
      name: "Şehir Otomotivleri",
      badge: "Maksimum Araç Stoğu",
      desc: "Yoğun kampanya dönemlerinde hızlı test sürüşü planlama ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli bayi servisi, dinamik satış kapama rezervasyonu ve aktivite planlama.",
    ...
    {
      icon: "fas fa-key",
      name: "Apart Otomotivler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır DMSsyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1620012253245-c529ce153d82?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Test Sürüşü Otomotivler",
      badge: "Up-Sell Odaklı",
      desc: "Servis randevuları, kişiye özel kür takipleri ve üyelik programları.",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "Otomotiv verileriyle AI otomotivi.",
    ...
    },
    {
      ...
      details: [
        "Tüm departmanlara özel otomotiv.",
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Müşteri Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Satış",
      description:
        "AI destekli web siteniz ve chatbot, müşterileri çeker ve komisyonsuz satış aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Otomotiv Öncesi İletişim",
      description:
        "Otomatik e-postalarla müşteri beklentisini yönetin ve ek hizmet (upsell) randevuları yapın.",
    },
    {
      icon: "fas fa-car",
      title: "Otomotiv Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), bayi servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                ...
                <span className="text-blue-400">Müşteri Sadakati Yaratın</span>
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanasotomotiv"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Müşteri Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, müşterilerinizin bayinizle ilk temasından, sadık bir
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Müşteri Deneyimi",
                    description:
                      "Yapay zeka, her müşteriye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir bayilerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Müşteri Tercih Havuzu",
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Otomotiv Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          <strong>Yüksek Komisyonlar:</strong> %15-25 Otomobil Portalı
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, araç stoğu ve diğer
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Müşteri Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, araç stoğu ve müşteri verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            stoklar ve bayi görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 müşteri memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Otomotivinizin her departmanını güçlendirmek için tasarlanmış 9
        ...
        <AutomotivePhoneDialogueSection />
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Otomotivinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, otomotivinizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    name: "Alex",
                    title: "Satış Uzmanı",
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve müşteri sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Otomotivcilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, otomotivcilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Müşteri verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun bayi fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın müşteri taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki araç stoğu oranlarını tahmin eder, müşteri kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Otomotivinizin her departmanını güçlendirmek için tasarlanmış
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Canlı Servis, galeri ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Otomotiv hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak müşteri memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    title: "Güçlü Servis Deneyimi",
                    description:
                      "Müşteri taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Otomotiviniz için uyarlanmış 9 farklı yazılım ve yapay zeka
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  1 ay boyunca geçerli %40 özel finansman ile tüm yıl masraflar
        ...
        {/* Müşteri İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Müşteri İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, otomotivlere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm müşteri iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: "fas fa-calendar-check",
                    title: "Satış Yönetimi Otomasyonu",
                    description:
                      "Müşteriler, uygun tarih ve araç tiplerine kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Müşteri Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, satış şartları, bayi hizmetleri, kampanyalar ve servis hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Araç teslimat detayları, test sürüşü tarihleri ve periyodik bakım randevuları müşterilere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve satış süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    ...
                    description:
                      "Yabancı uyruklu müşteriler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası müşteri memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Bayi ve Bölge Bilgilendirmesi",
                    description:
                      "Araç donanım paketleri, ödeme seçenekleri, finansman olanakları ve garanti imkanları hakkında bilgilendirici içerikler anında sunulur. Müşteriler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    ...
                    description:
                      "Müşterilerin tercihlerine ve araç tiplerine göre ek premium kredi, hediye paketi veya uzatılmış garanti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek bayi gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          ...
          subtitle="Müşteri memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm müşteri sorularını ve satış taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Müşteri Deneyimi",
              description:
                "Müşterilere bayi olanakları, test sürüşü randevuları ve yeni kampanya önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm otomotiv, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan satış danışmanı görevlerini otomatize ederek personelinizin daha stratejik ve müşteri odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki otomotivlerin
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan otomotivlerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
