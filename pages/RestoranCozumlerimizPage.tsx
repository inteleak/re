...
import RestaurantPhoneDialogueSection from "../components/RestaurantPhoneDialogueSection";
...
const RestoranCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2020/02/10/32049-389599587_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2019/10/16/27914-366579895_large.mp4",
    },
    {
      type: "image",
    ...
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1555396273-367dd4610115?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Butik Kafeler Restoran Çözümleri",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, canlı destek ekibimizin yükünü yarı yarıya azalttı. Artık misafirlerimizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde misafirlerimize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Rezervasyon & Pazarlama Direktörü, İstanbul Business Hrestoran",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Malzeme Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile malzeme oranımızı ve restoran başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel restorani çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Restoran Çözümlerii",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Butik Kafeler restoran sektöründe misafir deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Misafirlerimiz AI rezervasyon danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    {
      icon: "fas fa-hrestoran",
      title: "AI Restoran Çözümleri Yönetimi (CRM)",
      description:
        "Tüm restoran operasyonlarınızı (rezervasyon, restoran durumu, misafir ilişkileri) tek yerden yönetin.",
      path: "/uygulamalar/restoran-yonetimi-crm",
      features: [
        "Merkezi Misafir Veritabanı",
    ...
    },
    {
      ...
      description:
        "Misafirlerinize kişiselleştirilmiş deneyimler sunan, 7/24 rezervasyon alan akıllı bir web sitesi.",
      path: "/yapay-zeka-web/restoran",
      features: [
        "Komisyonsuz Rezervasyon Motoru",
    ...
    },
    {
      ...
      description:
        "WhatsApp, Instagram gibi kanallardan gelen mesajları otomatik yanıtlayın ve 7/24 rezervasyon yapın.",
      path: "/otomasyon/sosyal-medya-otomasyonu",
      features: [
        "Çoklu Kanal (Omnichannel)",
        "DM Kampanyaları & Çapraz Rezervasyon",
        "Rezervasyon Dönüşüm Takibi",
      ],
    },
    {
      icon: "fas fa-headset",
      title: "Sesli Misafir Hizmetleri",
      description:
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile misafir deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Restoran İçi Sesli Talepler",
    ...
    },
    {
      ...
      features: [
        ...
        "Rezervasyon Danışmanı ve Restoran Bilgisi",
    ...
    },
    {
      ...
      description:
        "Restoranınızın sepet, mutfak malzemeleri gibi malzemelerini anlık takip edin ve rezervasyonleri otomatikleştirin.",
      path: "/otomasyon/malzeme-yonetimi-otomasyonu",
      features: [
        "Kritik Malzeme Uyarıları",
    ...
    },
    {
      ...
      title: "AI Destekli Malzeme Optimizasyonu",
      description:
        "Piyasa talebini, rakip fiyatlarını ve etkinlikleri analiz ederek restoran fiyatlarınızı dinamik olarak optimize edin.",
      path: "/uygulamalar/restoran-yonetimi-crm",
      features: [
  ...
  const pricingTiers = [
    {
      ...
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik restoranler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    {
      name: "Profesyonel",
      rooms: "25-100 Restoran",
      monthly: 500,
      setup: 2500,
      popular: true,
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir restoranleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Malzeme Optimizasyonu",
        "Özel Misafir Temsilcisi",
        "Öncelikli Destek",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "100+ Restoran & Zincir Restoranlar",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük restoranler, kampanya köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Restoran Çözümleri",
        "Özel Destek Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Yemek Platformu Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Sesli Misafir Hizmetleri",
      butik: "200 dk/ay",
      profesyonel: "500 dk/ay",
      kurumsal: "Özelleştirilmiş",
    },
    {
      name: "AI Malzeme Optimizasyonu",
      butik: "Standart",
    ...
    {
      name: "Yerinde Kurulum & Restoran Çözümleri",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın restoran verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut restoran yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler POS ve restoran otomasyon programlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize restoran veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, rezervasyon, mutfak ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde restoranler düzenliyoruz. Ayrıca sürekli olarak video restoran materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla restorani tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu restoran (multi-property) yönetimini desteklemektedir. Zincir veya grup restoranleri, tüm mülklerinin rezervasyonlarını, malzeme oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
      question: "Misafir verilerinin güvenliği nasıl sağlanıyor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz HrestoranRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online rezervasyon kanallarınızdaki (Booking, Expedia, Airbnb vb.) restoran müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Restoran Çözümleri personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde mutfak personeliniz mutfak görevlerini anlık olarak takip edebilir, canlı destek ekibiniz misafir sipariş/paket servis süreci işlemlerini tabletten yapabilir ve yöneticiler restoran performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi restoranimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm misafir verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Malzeme, gelir ve misafir trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-hrestoran",
      name: "Butik Kafeler Restoran Çözümleriler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Misafirlere 7/24 kesintisiz, birinci restoran birebir asistanlık deneyimi sunar.",
      benefit: "%35 Rezervasyon Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir Restoran Çözümlerileri",
      badge: "Maksimum Malzeme",
      desc: "Yoğun iş seyahatlerinde hızlı misafir rezervasyon, anlık ödeme ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli restoran servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
      benefit: "%45 Daha Fazla Ek Hizmet Rezervasyonı",
      imageUrl:
        "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-wine-glass-alt",
      name: "Apart Restoran Çözümleriler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır Operasyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1555396273-367dd4610115?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Paket Servis Restoran Çözümleriler",
      badge: "Up-Sell Odaklı",
      desc: "Destek randevuları, kişiye özel kür takipleri ve üyelik programları.",
      benefit: "2.5 Kat Ek Randevu Rezervasyonı",
      imageUrl:
        "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=600&q=80",
    },
  ];
  ...
  const setupSteps = [
    {
      ...
      details: [
        ...
        "Rezervasyon hedeflerinin belirlenmesi.",
    ...
    },
    {
      ...
      details: [
        ...
        "Restoran Çözümleri verileriyle AI restorani.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-wine-glass-alt",
      title: "Restoran Çözümleri & Destek",
      details: [
        "Tüm departmanlara özel restoran.",
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Misafir Başı Gelir iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Rezervasyon",
      description:
        "AI destekli web siteniz ve chatbot, misafirleri çeker ve komisyonsuz rezervasyon aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Restoran Çözümleri Öncesi İletişim",
      description:
        "Otomatik e-postalarla misafir beklentisini yönetin ve ek hizmet (upsell) rezervasyonları yapın.",
    },
    {
      icon: "fas fa-utensils",
      title: "Restoran Çözümleri Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), restoran servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla misafirlerinizi tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                ...
                <span className="text-blue-400">Misafir Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                ...
                personel verimliliğini yükseltin ve misafirlerinize unutulmaz
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanasrestoran"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Misafir Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, misafirlerinizin restoraninizle ilk temasından, sadık bir
                misafire dönüşmesine kadar tüm süreci akıllıca ve kesintisiz
                bir şekilde yönetir.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  Restoran Çözümlericiliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
                <p className="mt-1.5 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, restoraninizi geleceğe taşıyacak üç stratejik
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Misafir Deneyimi",
                    description:
                      "Yapay zeka, her misafire adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir restoranlerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                      "Kişiselleştirilmiş Karşılama",
                      "Misafir Tercih Havuzu",
                  ...
                  },
                  {
                    ...
                    description:
                      "Hangi misafir segmentinin hangi tekliflere yanıt verdiğini anlayın. Pazarlama bütçenizi tahminlere değil, somut verilere dayalı olarak en kârlı kanallara yönlendirin.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Restoran Çözümleri Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 md:p-6 rounded-[1.5rem] border-2 border-red-500/20 shadow-xl shadow-red-900/10 relative overflow-hidden group hover:border-red-500/40 transition-colors duration-500">
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Pasif Varlık:</strong> Ziyaretçiyi misafire
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, malzeme ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel misafirler.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            <strong>Doğrudan Kâr:</strong> 7/24 rezervasyon alan
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Misafir Başı Gelir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, malzeme ve misafir verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            malzemelar ve restoran görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 misafir memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Restoranınızın her departmanını güçlendirmek için tasarlanmış 9
        ...
        <RestaurantPhoneDialogueSection />
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Restoranınızın Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, restoraninizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve misafir sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
                    title: "Sosyal Medya Yöneticisi",
                    role: "Instagram, WhatsApp ve Facebook'taki sohbetleri yönetir, rezervasyon fırsatları yaratır.",
                  },
                  {
                    icon: "fas fa-headset",
                    name: "Leo",
                    title: "Sesli Resepsiyonist",
                    role: "Telefon çağrılarını karşılar, sesli olarak rezervasyon alır ve personelinizi bilgilendirir.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    name: "Clara",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Restoran Çözümlericilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, restorancilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Misafir verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun restoran fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın misafir taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki malzeme oranlarını tahmin eder, misafir kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Restoranınızın her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "Misafirlerinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Canlı Destek, mutfak ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Restoran Çözümleri hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak misafir memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    ...
                    description:
                      "Misafir taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Restoran Çözümleriiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
        ...
        {/* Misafir İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Misafir İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, restoranlere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm misafir iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: "fas fa-calendar-check",
                    title: "Rezervasyon Yönetimi Otomasyonu",
                    description:
                      "Misafirler, uygun tarih ve masa türlerini kolayca görüntüleyerek tek tıkla rezervasyon oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Misafir Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, rezervasyon şartları, restoran olanakları, çalışma saatleri ve özel menü hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Restoran Çözümleri başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları misafirlere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve restoran süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-language",
                    title: "Çok Dilli Misafir Desteği",
                    description:
                      "Yabancı uyruklu misafirler için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası misafir memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-map-marked-alt",
                    title: "Restoran ve Bölge Bilgilendirmesi",
                    description:
                      "Restoran Çözümleri içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Misafirler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz Rezervasyon) Rezervasyonları",
                    description:
                      "Misafirlerin tercihlerine ve yemek tiplerine göre ek premium paket servis, hediye paketi veya uzatılmış garanti gibi ek hizmetleri doğru zamanda akıllıca teklif ederek restoran gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Restoran Çözümleri Sektörü için Mortanas AI?"
          subtitle="Misafir memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm misafir sorularını ve rezervasyon taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Misafir Deneyimi",
              description:
                "Misafirlere restoran olanakları, etüt randevuları ve kulüp sosyal etkinlik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm restoran, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan canlı destek görevlerini otomatize ederek personelinizin daha stratejik ve misafir odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki restoranlerin
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 lg:p-10 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)]">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  Mutlu Restoran Çözümleri{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Yöneticileri
                  </span>
                </h2>
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan restoranlerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)] text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto mb-6 text-xs md:text-sm text-slate-300 leading-relaxed font-medium">
                Uzman ekibimizle görüşerek restoraninizin ihtiyaçlarına özel bir
