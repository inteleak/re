...
import HealthPhoneDialogueSection from "../components/HealthPhoneDialogueSection";
...
const SaglikCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://media.istockphoto.com/id/1155981755/tr/video/bilim-insan%C4%B1-lab-bilgisayar-ekran%C4%B1nda-yapay-zeka-beyin-sim%C3%BClasyonu-%C3%BCzerinde-%C3%A7al%C4%B1%C5%9F%C4%B1yor.mp4?s=mp4-640x640-is&k=20&c=L_q1B5_53v0yTndY49Gq4f4vS0D6L2G9Y4i_GvLwSGo=",
    },
    {
      type: "image",
    ...
    {
      type: "video",
      src: "https://media.istockphoto.com/id/1498114389/tr/video/dna-with-ai-animation.mp4?s=mp4-640x640-is&k=20&c=3iEIf5zntfIu4gGvIot3u18D1Y9s62qf94oR_wVpT4I=",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&q=80&w=2000&auto=format&fit=crop",
    },
    {
      type: "image",
  ...
  const testimonials = [
    {
      quote:
        "Mortanas'ın hepsi bir arada çözümü sayesinde Acente komisyonlarımız %80 azaldı ve doğrudan rezervasyonlarımız tavan yaptı. Operasyonel verimliliğimizdeki artış ise inanılmaz.",
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Poliklinik Klinik",
      avatarUrl: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Sesli asistan ve sosyal medya otomasyonu, kayıt bankosu ekibimizin yükünü yarı yarıya azalttı. Artık hastalarımizle daha kaliteli zaman geçirebiliyoruz. Keşke daha önce geçseydik!",
      name: "Mehmet Yılmaz",
    ...
    {
      quote:
        "Yapay zeka web sitesi ve CRM entegrasyonu sayesinde hastalarımize gerçekten kişiselleştirilmiş bir deneyim sunuyoruz. Geri dönüş oranlarımızda %40 artış gördük.",
      name: "Canan Demir",
      title: "Satış & Pazarlama Direktörü, İstanbul Business Hklinik",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Kapasite yönetimi modülü harika. Dinamik fiyatlandırma özelliği ile randevu doluluğu oranımızı ve muayene başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
      title: "Gelirler Müdürü, Antalya Resort & Estetik Merkezi",
      avatarUrl: "https://randomuser.me/api/portraits/men/45.jpg",
    },
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel eğitimi çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Kliniki",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Poliklinik klinik süreçlerinde hasta deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Hastalarimiz AI hasta danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const calculateSavings = useCallback(() => {
    ...
    // The revenue we aim to convert from Acente to Direct
  ...
  const includedServices = [
    ...
    },
    {
      ...
      features: [
        ...
        "DM Kampanyaları & Ek Tetkik",
        "Satış Dönüşüm Takibi",
      ],
    },
    {
      icon: "fas fa-headset",
      title: "Sesli Müşteri Hizmetleri",
      description:
    ...
    },
    {
      ...
      description:
        "Web sitenizde ve uygulamalarınızda sesli komutlarla çalışan akıllı asistan ile hasta deneyimini zenginleştirin.",
      path: "/otomasyon/sesli-chatbot",
      features: [
        "Doğal Ses Simülasyonu",
        "Muayene İçi Sesli Talepler",
    ...
    },
    {
      ...
      title: "Stok Yönetimi",
      description:
        "Klinikinizin sarf malzemesi, temizlik malzemeleri gibi stoklarını anlık takip edin ve siparişleri otomatikleştirin.",
      path: "/otomasyon/stok-yonetimi-otomasyonu",
      features: [
  ...
  const pricingTiers = [
    {
      ...
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik klinikler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    {
      name: "Profesyonel",
      rooms: "25-100 Muayene",
      monthly: 500,
      setup: 2500,
      popular: true,
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir klinikleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Kapasite Yönetimi",
    ...
    {
      name: "Kurumsal",
      rooms: "100+ Muayene & Zincir Hastaneler",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük klinikler, şifa köyleri ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Takvim Yöneticisi Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    {
      name: "HBYS Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın klinik verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut klinik yönetim yazılımım (HBYS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler HBYS ve takvim yöneticisi ile tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize eğitim veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra kayıt bankosu, satış, klinik temizlik ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde eğitimler düzenliyoruz. Ayrıca sürekli olarak video eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla kliniki tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu klinik (multi-property) yönetimini desteklemektedir. Zincir veya grup klinikleri, tüm mülklerinin rezervasyonlarını, randevu doluluğu oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
      question: "Hasta verilerinin güvenliği nasıl sağlanıyor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz HklinikRunner, SiteMinder gibi sektörün önde gelen kanal yöneticileriyle tam entegre çalışır. Bu sayede tüm online satış kanallarınızdaki (Booking, Expedia, Airbnb vb.) muayene müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Klinik personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde klinik temizlik personeliniz temizlik görevlerini anlık olarak takip edebilir, kayıt bankosu ekibiniz hasta kayıt/hasta çıkış işlemlerini tabletten yapabilir ve yöneticiler klinik performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi klinikimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    {
      ...
      description:
        "Tüm hasta verileri, rezervasyonlar ve iletişim geçmişi tek bir yerde.",
    },
    {
      imageUrl:
    ...
    {
      imageUrl:
        "https://images.unsplash.com/photo-1555431189-0af5b0ad5277?auto=format&fit=crop&w=800&q=80",
      title: "Gelir ve Analitik Raporları",
      description:
        "Randevu Doluluğu, gelir ve hasta trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-hklinik",
      name: "Poliklinik Klinikler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Hastalara 7/24 kesintisiz, birinci sınıf birebir asistanlık deneyimi sunar.",
    ...
    },
    {
      ...
      name: "Şehir Klinikleri",
      badge: "Maksimum Randevu Doluluğu",
      desc: "Yoğun iş seyahatlerinde hızlı hasta kayıt, anlık ödeme ve sıfır kaçan çağrı.",
    ...
    },
    {
      ...
      desc: "Çok dilli muayene servisi, dinamik laboratuvar rezervasyonu ve aktivite planlama.",
    ...
    },
    {
      ...
      name: "Apart Klinikler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır Operasyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1516549655669-df83a0774514?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Fizik Tedavi Klinikler",
      badge: "Up-Sell Odaklı",
      desc: "Estetik Merkezi randevuları, kişiye özel kür takipleri ve üyelik programları.",
  ...
  const setupSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        "HBYS ve ödeme tam entegrasyonu.",
        "Klinik verileriyle AI eğitimi.",
    ...
    },
    {
      ...
      details: [
        ...
        "Dinamik Günlük Hasta Kapasitesi iyileştirmeleri.",
      ],
    },
  ];
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & Randevu",
      description:
        "AI destekli web siteniz ve chatbot, hastaları çeker ve komisyonsuz randevu aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Tedavi Öncesi İletişim",
      description:
        "Otomatik e-postalarla hasta beklentisini yönetin ve ek hizmet (upsell) satışları yapın.",
    },
    {
      icon: "fas fa-user-nurse",
      title: "Tedavi Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), muayene servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Sadakat & Geri Dönüş",
      description:
        "Otomatik geri bildirim toplama ve kişiselleştirilmiş kampanyalarla hastalarınızı tekrar kazanır.",
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                Telefon Trafiğini Unutun, <br />{" "}
                <span className="text-blue-400">Hasta Sadakati Yaratın</span>
              </h1>
              <p className="mt-6 text-lg text-blue-200">
                9'u 1 arada güç paketimizle kliniğinizin tüm operasyonlarını tek
                bir akıllı platformda birleştirin. Doğrudan randevuları artırın,
                sekreterya üzerindeki iş yükünü hafifletin ve hastalarınıza KVKK
                uyumlu 7/24 lüks bir dijital deneyim sunun.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanasklinik"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                Hasta Yolculuğunun Her Adımında{" "}
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                  Yanınızdayız
                </span>
              </h2>
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, hastainizin klinikinizle ilk temasından, sadık bir
                müşteriye dönüşmesine kadar tüm süreci akıllıca ve kesintisiz
                bir şekilde yönetir.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5 items-stretch">
                {[
                  {
                    icon: "fas fa-crown",
                    title: "Benzersiz Hasta Deneyimi",
                    description:
                      "Yapay zeka, her hastae adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir kliniklerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
                  ...
                  },
                  {
                    ...
                    description:
                      "Hangi müşteri segmentinin hangi tekliflere yanıt verdiğini anlayın. Pazarlama bütçenizi tahminlere değil, somut verilere dayalı olarak en kârlı kanallara yönlendirin.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Klinik Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          <strong>Yüksek Komisyonlar:</strong> %15-25 Acente
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Pasif Varlık:</strong> Ziyaretçiyi müşteriye
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> HBYS, stok ve diğer
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        ...
                        <span className="truncate">
                          ...
                          kalan çağrılar ve potansiyel hastalar.
                        </span>
                      </li>
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            analizleriyle maksimize edilmiş Günlük Hasta Kapasitesi.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                          <span className="truncate">
                            ...
                            rezervasyonlar, stok ve hasta verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            stoklar ve muayene görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            kurtulup %100 hasta memnuniyetine odaklı personel.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Klinikinizin her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Klinikinizin Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, klinikinizin farklı departmanları için uzmanlaşmış
                ...
                {[
                  {
                    ...
                    role: "7/24 çalışır, tüm kanallardan rezervasyonları alır ve hasta sorularını yanıtlar.",
                  },
                  {
                    icon: "fas fa-comments-dollar",
                    name: "Sofia",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Klinikcilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, klinikcilik sektörü için özel olarak
                ...
                {[
                  {
                    ...
                    description:
                      "Hasta verilerini analiz ederek kişiselleştirilmiş teklifler, upsell fırsatları ve pazarlama mesajları oluşturur.",
                  },
                  {
                    icon: "fas fa-dollar-sign",
                    title: "Dinamik Fiyatlandırma",
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun muayene fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                    icon: "fas fa-comments",
                    title: "Doğal Dil İşleme (NLP)",
                    description:
                      "Chatbot ve sesli asistanlarımızın hasta taleplerini bir insan gibi anlamasını ve yanıtlamasını sağlar.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    title: "Tahmine Dayalı Analitik",
                    description:
                      "Gelecekteki randevu doluluğu oranlarını tahmin eder, hasta kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Klinikinizin her departmanını güçlendirmek için tasarlanmış
                ...
                {[
                  {
                    ...
                    description:
                      "Hastalarinizle e-posta, sohbet, telephone ve WhatsApp gibi tüm kanallardan kesintisiz iletişim kurun.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-cogs",
                    ...
                    description:
                      "Kayıt Bankosu, klinik temizlik ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Klinik hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
                    ...
                    description:
                      "BT desteğine gerek duymadan hızlı kurulum yapın, sistemi kolayca kullanarak hasta memnuniyetine odaklanın.",
                    theme: "emerald",
                  },
                  {
                    icon: "fas fa-headset",
                    ...
                    description:
                      "Hasta taleplerini kolayca yönetin, kişiselleştirilmiş teklifler sunun ve beklentileri aşın.",
                    theme: "amber",
                  },
                  {
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Klinikiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
        ...
        {/* Hasta İletişimini Nasıl Dönüştürüyoruz? Section */}
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                <h2 className="text-xl md:text-2xl font-extrabold tracking-tight text-white mb-1">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Hasta İletişimini Nasıl Dönüştürüyoruz?
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, kliniklere hız, esneklik ve 7/24 hizmet imkânı
                  sunarak tüm hasta iletişim süreçlerini dijitalleştirir.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Hastalar, uygun tarih ve muayene tiplerini kolayca görüntüleyerek tek tıkla randevu oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    icon: "fas fa-comments-alt",
                    title: "Hasta Sorularına Anında Yanıt",
                    description:
                      "Yapay zeka asistanımız, randevu şartları, klinik olanakları, laboratuvar saatleri ve SPA hizmetleri gibi konularda 7/24 anında yanıt verir. Resepsiyona gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Tedavi öncesi giriş detayları, havaalanı transferleri ve laboratuvar rezervasyonları hastalara otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve tedavi süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-language",
                    title: "Çok Dilli Hasta Desteği",
                    description:
                      "Yabancı uyruklu hastalar için anında çeviriyle birden fazla dilde doğru ve anlaşılır iletişim sağlanır. Yapay zeka asistanı, yanlış anlamaların önüne geçer ve uluslararası hasta memnuniyetini artırır.",
                    theme: "emerald",
                  },
                  {
                    ...
                    description:
                      "Klinik içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Hastalar tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Ek Tetkik) Satışları",
                    description:
                      "Hastalarin tercihlerine ve tedavi tiplerine göre muayene yükseltme, SPA veya özel akşam yemeği gibi ek hizmetleri doğru zamanda akıllıca teklif ederek klinik gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Klinik Sektörü için Mortanas AI?"
          subtitle="Hasta memnuniyetini artırırken, operasyonel verimliliği en üst düzeye çıkaran akıllı çözüm ortağınız."
          points={[
            {
              icon: "fa-headset",
              title: "7/24 Kesintisiz İletişim",
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm hasta sorularını ve randevu taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Hasta Deneyimi",
              description:
                "Hastalara klinik olanakları, laboratuvar rezervasyonları ve tetkik önerileri hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm tedavi, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
              title: "İdari Yükü Azaltın",
              description:
                "Tekrarlayan kayıt bankosu görevlerini otomatize ederek personelinizin daha stratejik ve hasta odaklı yüz yüze hizmetlere odaklanmasını sağlayın.",
            },
          ]}
          themeColor="blue"
        />
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki kliniklerin
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan kliniklerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)] text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto mb-6 text-xs md:text-sm text-slate-300 leading-relaxed font-medium">
                Uzman ekibimizle görüşerek klinikinizin ihtiyaçlarına özel bir
