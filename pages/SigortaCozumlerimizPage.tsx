...
import InsurancePhoneDialogueSection from "../components/InsurancePhoneDialogueSection";
...
const SigortaCozumlerimizPage: React.FC = () => {
  ...
  const sliderItems = [
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2019/08/25/26252-355152062_large.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "video",
      src: "https://cdn.pixabay.com/video/2016/11/21/6517-193481261_tiny.mp4",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
    {
      type: "image",
      src: "https://images.unsplash.com/photo-1444653389962-8149286c578a?auto=format&fit=crop&w=2000&q=80?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      name: "Ayşe Güneş",
      title: "Genel Müdür, Ege Bağımsız Acenteler Sigorta Çözümleri",
    ...
    },
    {
      ...
      name: "Canan Demir",
      title: "teklif & Pazarlama Direktörü, Güneş Sigorta Acenteliği",
      avatarUrl: "https://randomuser.me/api/portraits/women/45.jpg",
    },
    {
      quote:
        "Poliçe Optimizasyonu modülü harika. Dinamik fiyatlandırma özelliği ile Poliçe oranımızı ve Sigorta Acentesi başına gelirimizi optimize etmeyi başardık. Raporlama araçları çok detaylı.",
      name: "Ahmet Çelik",
    ...
    {
      quote:
        "6 farklı sistemi tek bir panelde birleştirmek, hayatımızı kurtardı. Personel acentesi çok daha kolay ve tüm verilerimiz artık tek bir yerde, güvende. Bu yatırımın karşılığını fazlasıyla aldık.",
      name: "Selin Aksoy",
      title: "Operasyon Yöneticisi, Uludağ Kayak Sigorta Çözümlerii",
      avatarUrl: "https://randomuser.me/api/portraits/women/46.jpg",
    },
    {
      quote:
        "Bağımsız Acenteler sigorta sektöründe üye deneyimi her şeydir. Mortanas platformu, teknolojiyi kullanarak bu deneyimi bir üst seviyeye taşımamızı sağladı. Müşterilerimiz AI teklif danışmanı özelliğine bayılıyor!",
      name: "Mustafa Arslan",
  ...
  const includedServices = [
    ...
    },
    {
      ...
      description:
        "WhatsApp, Instagram gibi kanallardan gelen mesajları otomatik yanıtlayın ve 7/24 teklif yapın.",
      path: "/otomasyon/sosyal-medya-otomasyonu",
      features: [
        "Çoklu Kanal (Omnichannel)",
        "DM Kampanyaları & Çapraz teklif",
        "teklif Dönüşüm Takibi",
      ],
    },
    {
      icon: "fas fa-headset",
    ...
    },
    {
      ...
      features: [
        ...
        "Sigorta Acentesi İçi Sesli Talepler",
    ...
    },
    {
      ...
      description:
        "Sigorta Acentesiınızın sepet, Acente malzemeleri gibi ekipmanlarını anlık takip edin ve rezervasyonleri otomatikleştirin.",
      path: "/otomasyon/Poliçe-yonetimi-otomasyonu",
      features: [
        "Kritik Poliçe Uyarıları",
  ...
  const pricingTiers = [
    {
      name: "Bağımsız Acenteler",
      rooms: "5-25 Sigorta Acentesi",
      monthly: 250,
      setup: 1500,
      popular: false,
      isEnterprise: false,
      description: "Küçük ve butik acenteler için ideal, komisyonsuz başlangıç.",
      features: [
        "Tüm 9 Çözüm Modülü",
    ...
    {
      name: "Profesyonel",
      rooms: "25-100 Sigorta Acentesi",
      monthly: 500,
      setup: 2500,
      popular: true,
      isEnterprise: false,
      description:
        "Büyüyen operasyonlar ve şehir acenteleri için en popüler çözüm.",
      features: [
        "Tüm 9 Çözüm Modülü",
        "Gelişmiş AI Poliçe Optimizasyonu",
        "Özel Üye Temsilcisi",
        "Öncelikli Destek",
      ],
    },
    {
      name: "Kurumsal",
      rooms: "Popüler Sigorta Şirketleri",
      monthly: 0, // Custom price
      setup: 0, // Custom price
      popular: false,
      isEnterprise: true,
      description:
        "Büyük acenteler, kurumsal acenteler ve zincirler için ölçeklenebilir, özel çözümler.",
      features: [
        "Özelleştirilebilir Modüller",
        "Özel API Erişimi",
        "Yerinde Kurulum & Sigorta Çözümleri",
        "Özel Destek Hattı",
      ],
    },
  ];
  ...
  const comparisonFeatures = [
    ...
    {
      name: "Teminat Platformu Entegrasyonu",
      butik: true,
      profesyonel: true,
      kurumsal: true,
    },
    ...
    {
      name: "Yerinde Kurulum & Sigorta Çözümleri",
      butik: false,
      profesyonel: false,
      kurumsal: true,
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Tüm sistemin entegrasyonu ve yapay zekanın Sigorta Acentesi verilerinizle eğitilmesi dahil olmak üzere anahtar teslim kurulum sürecimiz ortalama 7-10 iş günü sürmektedir. Süreç boyunca proje yöneticimiz sizinle sürekli iletişim halinde olacaktır.",
    },
    {
      question: "Mevcut Sigorta Acentesi yönetim yazılımım (ÖBS) ile entegre olabilir mi?",
      answer:
        "Evet, çözüm paketimiz Elektra, Opera, Fidelio gibi birçok popüler CRM ve Acente yönetim yazılımlarıyla tam entegre çalışabilmektedir. Mevcut altyapınızı analiz ederek sorunsuz bir geçiş sağlıyoruz.",
    },
    {
    ...
    {
      question: "Ekibimize Sigorta Acentesi veriyor musunuz?",
      answer:
        "Kesinlikle. Kurulum tamamlandıktan sonra canlı destek, teklif, Acente ve yönetim dahil olmak üzere tüm ekibinize özel online ve/veya yerinde acenteler düzenliyoruz. Ayrıca sürekli olarak ürün eğitim materyalleri ve destek sağlıyoruz.",
    },
    {
    ...
    {
      question: "Birden fazla acentesi tek bir hesaptan yönetebilir miyim?",
      answer:
        "Evet, platformumuz çoklu Sigorta Acentesi (multi-property) yönetimini desteklemektedir. Zincir veya grup acenteleri, tüm mülklerinin tekliflerinı, Poliçe oranlarını ve finansal raporlarını tek bir merkezi panelden kolayca yönetebilir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Evet, çözümümüz SigortaRunner, SiteMinder gibi sektörün önde gelen Acente yönetim yazılımlarıyla tam entegre çalışır. Bu sayede tüm online teklif kanallarınızdaki (Sigortam.net, Koalay vb.) Sigorta Acentesi müsaitliğiniz ve fiyatlarınız anlık olarak senkronize olur.",
    },
    {
      question: "Sigorta Çözümleri personeli için bir mobil uygulama var mı?",
      answer:
        "Evet, hem iOS hem de Android için geliştirdiğimiz mobil uygulama sayesinde Acente personeliniz Acente görevlerini anlık olarak takip edebilir, canlı destek ekibiniz üye üyelik/kayıt süreci işlemlerini tabletten yapabilir ve yöneticiler Sigorta Acentesi performansını cepten izleyebilir.",
    },
    {
      question:
        "Platformu kendi acentesimizin ihtiyaçlarına göre özelleştirebilir miyiz?",
      answer:
  ...
  const platformModules = [
    ...
    },
    {
      ...
      description:
        "Poliçe, gelir ve üye trendleri hakkında anlık, veriye dayalı raporlar alın.",
    },
  ];
  ...
  const idealFor = [
    {
      icon: "fas fa-Sigorta",
      name: "Bağımsız Acenteler Sigorta Çözümleriler",
      badge: "Özelleştirilmiş Lüks",
      desc: "Müşterilere 7/24 kesintisiz, birinci Sigorta Acentesi birebir asistanlık deneyimi sunar.",
      benefit: "%35 teklif Artışı",
      imageUrl:
        "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-building",
      name: "Şehir Sigorta Çözümlerileri",
      badge: "Maksimum Poliçe",
      desc: "Yoğun iş seyahatlerinde hızlı üye teklif, anlık ödeme ve sıfır kaçan çağrı.",
      benefit: "%85 Personel Verimliliği",
      imageUrl:
        "https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-heart",
      name: "Üniversiteler",
      badge: "Zengin Deneyim",
      desc: "Çok dilli Sigorta Acentesi servisi, dinamik checkout rezervasyonu ve aktivite planlama.",
      benefit: "%45 Daha Fazla Ek Hizmet teklifı",
      imageUrl:
        "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-file-invoice-dollar",
      name: "Apart Sigorta Çözümleriler",
      badge: "Tam Otomasyon",
      desc: "Ön bürosuz otonom operasyon, dijital anahtarlar ve sıfır bekleme süresi.",
      benefit: "Sıfır Operasyonel Kayıp",
      imageUrl:
        "https://images.unsplash.com/photo-1444653389962-8149286c578a?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
    {
      icon: "fas fa-spa",
      name: "Hasar Destek Sigorta Çözümleriler",
      badge: "Up-Sell Odaklı",
      desc: "Destek randevuları, kişiye özel kür takipleri ve üyelik Poliçelerı.",
      benefit: "2.5 Kat Ek teklif teklifı",
      imageUrl:
        "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=2000&q=80?auto=format&fit=crop&w=600&q=80",
    },
  ];
  ...
  const setupSteps = [
    {
      ...
      details: [
        ...
        "teklif hedeflerinin belirlenmesi.",
    ...
    },
    {
      ...
      details: [
        ...
        "Sigorta Çözümleri verileriyle AI acentesi.",
    ...
    },
    {
      num: 3,
      icon: "fas fa-file-invoice-dollar",
      title: "Sigorta Çözümleri & Destek",
      details: [
        "Tüm departmanlara özel Sigorta Acentesi.",
  ...
  const guestJourneySteps = [
    {
      ...
      title: "Keşif & teklif",
      description:
        "AI destekli web siteniz ve chatbot, müşterileri çeker ve komisyonsuz teklif aldırır.",
    },
    {
      icon: "fas fa-envelope-open-text",
      title: "Sigorta Çözümleri Öncesi İletişim",
      description:
        "Otomatik e-postalarla üye beklentisini yönetin ve ek hizmet (upsell) rezervasyonları yapın.",
    },
    {
      icon: "fas fa-shield-alt",
      title: "Sigorta Çözümleri Deneyimi",
      description:
        "AI Asistan (WhatsApp/Sesli), Sigorta Acentesi servisi ve diğer talepleri 7/24 karşılayarak kusursuz bir deneyim sunar.",
    },
    {
  ...
  return (
    <div className="bg-slate-900 text-slate-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://www.mortanas.com/mortanassigorta"
                  target="_blank"
      ...
      <div className="py-0 space-y-1">
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-slate-900/90 to-slate-900 text-white rounded-3xl p-3 md:p-4 lg:p-5 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full text-center mb-4">
              ...
              <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Platformumuz, müşterilerinizin acenteninizle ilk temasından, sadık bir
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1.5">
                  Sigorta Çözümlericiliğin Geleceği için{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    3 Temel Direk
                  </span>
                </h2>
                <p className="mt-1.5 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, acenteninizi geleceğe taşıyacak üç stratejik
                ...
                {[
                  {
                    ...
                    description:
                      "Yapay zeka, her üyeye adıyla hitap eder, geçmiş tercihlerini hatırlar ve onlara özel teklifler sunar. Bu, zincir acentelerin bile sunamadığı bir kişiselleştirme seviyesidir.",
                    features: [
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-6 md:mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Sigorta Çözümleri Yönetiminde Devrim: Kaostan Kontrole
                </h2>
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 md:p-6 rounded-[1.5rem] border-2 border-red-500/20 shadow-xl shadow-red-900/10 relative overflow-hidden group hover:border-red-500/40 transition-colors duration-500">
                    ...
                    <ul className="space-y-1.5 text-slate-400 text-[12px] md:text-[13px] relative z-10">
                      ...
                      <li className="flex items-center overflow-hidden w-full">
                        <i className="fas fa-times-circle text-red-500/70 mr-2 flex-shrink-0"></i>
                        <span className="truncate">
                          <strong>Dağınık Dağıtım:</strong> ÖBS, Poliçe ve diğer
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-1.5 text-slate-300 text-[12px] md:text-[13px]">
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            <strong>Doğrudan Kâr:</strong> 7/24 teklif alan
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            rezervasyonlar, Poliçe ve üye verisi tek akıllı
                            CRM'de.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                        ...
                        <li className="flex items-center overflow-hidden w-full">
                          ...
                          <span className="truncate">
                            ...
                            malzemelar ve Sigorta Acentesi görevleri otomatikleşir.
                          </span>
                        </li>
                        <li className="flex items-center overflow-hidden w-full">
                          <i className="fas fa-check-circle text-blue-400 mr-2 flex-shrink-0"></i>
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm md:text-base text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Sigorta Acentesiınızın her departmanını güçlendirmek için tasarlanmış 9
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Tanışın: Sigorta Acentesiınızın Yeni Akıllı Ekibi
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuz, acenteninizin farklı departmanları için uzmanlaşmış
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    role: "Instagram, WhatsApp ve Facebook'taki sohbetleri yönetir, teklif fırsatları yaratır.",
                  },
                  {
                    icon: "fas fa-headset",
                    name: "Leo",
                    title: "Sesli Resepsiyonist",
                    role: "Telefon çağrılarını karşılar, sesli olarak teklif alır ve personelinizi bilgilendirir.",
                  },
                  {
                    icon: "fas fa-chart-line",
                    name: "Clara",
            ...
            <div className="container mx-auto px-8 relative z-10">
              <div className="text-center mb-8 md:mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Akıllı Sigorta Çözümlericilik Motoru
                  </span>
                </h2>
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Platformumuzun gücü, sigorta sektörü için özel olarak
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Piyasa talebini, rakip fiyatlarını ve etkinlikleri izleyerek en uygun Sigorta Acentesi fiyatlarını gerçek zamanlı olarak önerir.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description:
                      "Gelecekteki Poliçe oranlarını tahmin eder, üye kayıp riskini belirler ve stratejik kararlar için içgörüler sunar.",
                  },
                ].map((engine, index) => {
                  const themes = [
                    {
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-7 md:p-11 lg:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-4">
                ...
                <p className="mt-1 text-sm text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Sigorta Acentesiınızın her departmanını güçlendirmek için tasarlanmış
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Canlı Destek, Acente ve yönetim arasında sorunsuz işbirliği sağlayın, süreçleri ve raporlamayı otomatikleştirin.",
                    theme: "purple",
                  },
                  {
                    ...
                    description:
                      "Sigorta Çözümleri hizmetleri, çevre aktiviteleri ve sıkça sorulan soruları bilgi tabanında toplayın, kolayca güncelleyin.",
                    theme: "cyan",
                  },
                  {
                    icon: "fas fa-magic",
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left text-white">
                ...
                <p className="mt-4 text-[14px] md:text-base text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  Sigorta Çözümleriiniz için uyarlanmış 9 farklı yazılım ve yapay zeka
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/90 to-slate-950 text-white rounded-3xl p-2.5 md:p-3.5 lg:p-4 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="relative z-10 w-full">
              <div className="text-center mb-3">
                ...
                <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                  Mortanas AI, acentelere hız, esneklik ve 7/24 hizmet imkânı
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    icon: "fas fa-calendar-check",
                    title: "teklif Yönetimi Otomasyonu",
                    description:
                      "Müşteriler, uygun tarih ve poliçe türlerini kolayca görüntüleyerek tek tıkla teklif oluşturabilir. Mortanas AI, iptalleri ve güncellemeleri otomatik işleyerek operasyon ekibinin zaman planlamasını kolaylaştırır.",
                    theme: "blue",
                  },
                  {
                    ...
                    description:
                      "Yapay zeka asistanımız, teklif şartları, Sigorta Acentesi olanakları, çalışma saatleri ve özel menü hizmetleri gibi konularda 7/24 anında yanıt verir. Danışmaya gelen tekrarlayan sorular azalır ve personelin iş yükü hafifler.",
                    theme: "purple",
                  },
                  {
                    icon: "fas fa-bell-on",
                    ...
                    description:
                      "Sigorta Çözümleri başlangıç detayları, deneme sınavı tarihleri ve etüt randevuları müşterilere otomatik olarak hatırlatılır. Bu sayede iletişimsizlik azalır ve Sigorta Acentesi süreci pürüzsüz ilerler.",
                    theme: "cyan",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    title: "Sigorta Acentesi ve Bölge Bilgilendirmesi",
                    description:
                      "Sigorta Çözümleri içi aktiviteler, çevre gezileri, popüler turistik noktalar ve ulaşım imkanları hakkında bilgilendirici içerikler anında sunulur. Müşteriler tesise gelmeden önce de detaylı bilgiye ulaşabilir.",
                    theme: "amber",
                  },
                  {
                    icon: "fas fa-sparkles",
                    title: "Ek Hizmet (Çapraz teklif) Rezervasyonları",
                    description:
                      "müşterilerin tercihlerine ve Teminat tiplerine göre ek premium PT hizmeti, supplement paketi veya diyetisyen danışmanlığı gibi ek hizmetleri doğru zamanda akıllıca teklif ederek Sigorta Acentesi gelirlerini artırır.",
                    theme: "pink",
                  },
                ].map((item, index) => {
                  const t = {
        ...
        <WhyMortanasSection
          title="Neden Sigorta Çözümleri Sektörü için Mortanas AI?"
          ...
          points={[
            {
              ...
              description:
                "Yoğun sezonlarda veya gece saatlerinde bile tüm üye sorularını ve teklif taleplerini anında yanıtlayarak hiçbir fırsatı kaçırmayın.",
            },
            {
              icon: "fa-star",
              title: "Gelişmiş Üye Deneyimi",
              description:
                "Müşterilere Sigorta Acentesi olanakları, poliçe yenileme ve özel kampanyalar hakkında kişiselleştirilmiş, anlık bilgiler sunarak bağlılığı artırın.",
            },
            {
              icon: "fa-shield-halved",
              title: "Veri Güvenliği ve KVKK Uyumu",
              description:
                "Tüm Sigorta Acentesi, kimlik ve ödeme verileri, KVKK standartlarına uygun, yüksek güvenlikli altyapımızda titizlikle korunur.",
            },
            {
              icon: "fa-cogs",
        ...
        <section className="container mx-auto px-8 py-8">
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/45 via-slate-900/95 to-slate-950 text-white rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl relative overflow-hidden w-full">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="mt-4 text-base md:text-lg text-slate-300/90 max-w-2xl mx-auto leading-relaxed">
                Çözümümüz, farklı büyüklükteki ve segmentlerdeki acentelerin
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 lg:p-10 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)]">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-2">
                  Mutlu Sigorta Çözümleri{" "}
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">
                    Yöneticileri
                  </span>
                </h2>
                <p className="text-xs md:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed">
                  Çözümümüzü kullanan acentelerin sahipleri ve yöneticileri ne
                  diyor?
                </p>
              </div>
          ...
          <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-950/40 via-slate-900/95 to-slate-950 text-white rounded-3xl p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden w-full transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(59,130,246,0.05)] text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto mb-6 text-xs md:text-sm text-slate-300 leading-relaxed font-medium">
                Uzman ekibimizle görüşerek acenteninizin ihtiyaçlarına özel bir
