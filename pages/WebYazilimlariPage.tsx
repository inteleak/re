...
const WEB_YAZILIM_ITEMS = [
    { name: 'Otel Web Yazılımı', path: '/yapay-zeka-web/otel', icon: 'fas fa-hotel', color: 'text-blue-500', bg: 'bg-gradient-to-br from-blue-500 to-indigo-600', shadow: 'shadow-blue-500/20', description: 'Oteller için doğrudan rezervasyon altyapılı, yüksek dönüşümlü premium web siteleri.' },
    { name: 'Sağlık Web Yazılımı', path: '/yapay-zeka-web/saglik', icon: 'fas fa-heartbeat', color: 'text-rose-500', bg: 'bg-gradient-to-br from-rose-500 to-red-600', shadow: 'shadow-rose-500/20', description: 'Klinik ve doktorlar için hasta odaklı, online randevu özellikli modern web tasarımları.' },
    { name: 'Eğitim Web Yazılımı', path: '/yapay-zeka-web/egitim', icon: 'fas fa-graduation-cap', color: 'text-purple-500', bg: 'bg-gradient-to-br from-purple-500 to-fuchsia-600', shadow: 'shadow-purple-500/20', description: 'Üniversiteler, okullar ve kurslar için güven veren etkileyici web yazılımları.' },
    { name: 'E-Ticaret Web Yazılımı', path: '/yapay-zeka-web/eticaret', icon: 'fas fa-shopping-cart', color: 'text-orange-500', bg: 'bg-gradient-to-br from-orange-400 to-amber-600', shadow: 'shadow-orange-500/20', description: 'Satış odaklı, hızlı ve SEO uyumlu B2B & B2C e-ticaret platformları.' },
    { name: 'Otomotiv Web Yazılımı', path: '/yapay-zeka-web/otomotiv', icon: 'fas fa-car', color: 'text-slate-400', bg: 'bg-gradient-to-br from-slate-400 to-slate-600', shadow: 'shadow-slate-500/20', description: 'Galeriler ve yetkili servisler için detaylı filtreleme özellikli araç vitrin siteleri.' },
    { name: 'Hukuk Web Yazılımı', path: '/yapay-zeka-web/hukuk', icon: 'fas fa-gavel', color: 'text-yellow-500', bg: 'bg-gradient-to-br from-yellow-500 to-amber-600', shadow: 'shadow-yellow-500/20', description: 'Hukuk büroları için saygınlık uyandıran, kurumsal ve şık web projeleri.' },
    { name: 'Restoran Web Yazılımı', path: '/yapay-zeka-web/restoran', icon: 'fas fa-utensils', color: 'text-emerald-500', bg: 'bg-gradient-to-br from-emerald-400 to-teal-600', shadow: 'shadow-emerald-500/20', description: 'Menü entegreli, online sipariş veya rezervasyon altyapılı restoran siteleri.' },
    { name: 'Fitness Web Yazılımı', path: '/yapay-zeka-web/fitness', icon: 'fas fa-dumbbell', color: 'text-pink-500', bg: 'bg-gradient-to-br from-pink-500 to-rose-600', shadow: 'shadow-pink-500/20', description: 'Spor salonları için enerjik görünümlü, online üyelik özellikli web çözümleri.' },
    { name: 'Sigorta Web Yazılımı', path: '/yapay-zeka-web/sigorta', icon: 'fas fa-shield-alt', color: 'text-sky-500', bg: 'bg-gradient-to-br from-sky-400 to-cyan-600', shadow: 'shadow-sky-500/20', description: 'Sigorta acenteleri için güven veren kurumsal kimlik ve teklif alma modülleri.' },
    { name: 'Güzellik Web Yazılımı', path: '/yapay-zeka-web/spa', icon: 'fas fa-magic', color: 'text-indigo-400', bg: 'bg-gradient-to-br from-indigo-400 to-violet-600', shadow: 'shadow-indigo-500/20', description: 'Etkileyici görsel yapı, esnek sanal randevu takvimi ve hizmet katalog sistemleri.' },
    { name: 'Diyetisyen Web Yazılımı', path: '/yapay-zeka-web/diyetisyen', icon: 'fas fa-apple-alt', color: 'text-green-500', bg: 'bg-gradient-to-br from-green-400 to-emerald-600', shadow: 'shadow-green-500/20', description: 'Uzman kimliğinizi yansıtan, blog ve danışan başvuru formlarıyla entegre projeler.' },
    { name: 'Emlak Web Yazılımı', path: '/yapay-zeka-web/emlak', icon: 'fas fa-home', color: 'text-cyan-500', bg: 'bg-gradient-to-br from-cyan-400 to-blue-600', shadow: 'shadow-cyan-500/20', description: 'Harita destekli, zengin gayrimenkul vitrinine sahip hızlı ilan siteleri.' },
];
...
const WebYazilimlariPage: React.FC = () => {
        ...
        <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-blue-500/30 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            ...
                            SEKTÖREL WEB YAZILIM ÇÖZÜMLERİ
                        </motion.span>
                        <motion.h1 
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            İşletmenizin dijital dünyadaki gücünü artırın. İhtiyacınıza tam uygun özelliklerle donatılmış, yüksek performanslı, SEO uyumlu ve eşsiz bir deneyim sunan web platformları tasarlıyor ve geliştiriyoruz.
                        </motion.p>
                    </div>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#071029] via-[#0B1F4D] to-[#172554] pt-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 relative z-10">
                    ...
                    {WEB_YAZILIM_ITEMS.map((sector, index) => (
                        <motion.div
                            key={sector.name}
                            initial={{ opacity: 0, y: 20 }}
                ...
                >
                    ...
                    <div className="lg:max-w-2xl text-center lg:text-left relative z-10">
                        <h2 className="text-2xl md:text-3xl font-black text-white mb-4 tracking-tight">Üstün Kalitede Özel Web Projeleri</h2>
                        <p className="text-slate-400 text-base md:text-lg font-medium leading-relaxed">
                            Web sitelerimiz sadece görünüm olarak değil, teknik altyapı, güvenlik, SEO ve performans olarak da en yüksek değerleri karşılar. Müşterilerinizi etkileyecek ve işinizi hızla büyütecek projelere imza atıyoruz.
                        </p>
                    </div>
...
export default WebYazilimlariPage;
