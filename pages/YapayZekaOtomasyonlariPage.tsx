        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 to-indigo-900 text-slate-300 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
                                    ...
                                    <div className="space-y-2.5">
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            {solution.socialProof && (
                                                <span className={`text-[10px] shrink-0 font-bold px-2.5 py-1 rounded-full border ${t.badge}`}>
                                                    {solution.socialProof.count}+ {solution.socialProof.label.split(' ')[0]}
                                                </span>
                                            )}
                                        </div>
                                        <p className="text-slate-300 font-semibold text-xs md:text-[13px] leading-relaxed line-clamp-2">
                ...
                >
                    ...
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-100 to-indigo-300 mb-4 relative z-10 tracking-tight uppercase">İhtiyacınıza Özel Çözüm Mü Arıyorsunuz?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5 relative z-10">
                        ...
                        >
                            <i className="fab fa-whatsapp text-green-400 group-hover:text-green-300 mr-2.5"></i>
                            <span className="font-sans">WhatsApp'tan Yazın</span>
                        </a>
                    </div>
                </motion.div>
            </div>
